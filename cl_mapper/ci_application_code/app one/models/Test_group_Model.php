<?php class Test_group_model extends CI_Model {
  function test_group_create($test_method_test_method_id) {
    $test_group_post = [];
  ...
  function test_group_update($test_method_id,$group_id) {
    $test_group_post['test_method.test_method_id'] = $this->session->test_method_test_method_id;
  ...
  function test_group_get_records($test_method_id,$group_id) {
    ...
    $this->db->select('test_method.test_method_id AS test_group_test_method_id, test_group.binary_negative AS test_group_binary_negative,
    test_group.binary_positive AS test_group_binary_positive, test_group.binary_result AS test_group_binary_result,
    test_group.group_id AS test_group_group_id, test_group.group_name AS test_group_group_name,
    test_group.has_result AS test_group_has_result, test_group.interpretation AS test_group_interpretation,
    test_group.numeric_result AS test_group_numeric_result, test_group.numeric_result_unit AS test_group_numeric_result_unit,
    test_group.temp_group_id AS test_group_temp_group_id, test_group.temp_test_group_id AS test_group_temp_test_group_id,
    test_group.test_method_id AS test_group_test_method_id, test_group.text_result AS test_group_text_result')->from('test_group');
