<?php class Test_area_model extends CI_Model {
  function test_area_create($department_department_id,$hospital_hospital_id,$staff_previous_hospital_hospital_id) {
    $test_area_post = [];
  ...
  function test_area_update($department_id,$hospital_id,$hospital_id,$test_area_id) {
    $test_area_post['department.department_id'] = $this->session->department_department_id;
    $test_area_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $test_area_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function test_area_get_records($department_id,$hospital_id,$hospital_id,$test_area_id) {
    ...
    staff_previous_hospital.hospital_id AS test_area_hospital_id, test_area.department_id AS test_area_department_id,
    test_area.hospital_id AS test_area_hospital_id, test_area.temp_test_area_id AS test_area_temp_test_area_id,
    test_area.test_area AS test_area_test_area, test_area.test_area_id AS test_area_test_area_id')->from('test_area');
