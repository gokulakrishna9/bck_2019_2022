<?php class Antibiotic_test_model extends CI_Model {
  function antibiotic_test_create($antibiotic_antibiotic_id,$micro_organism_test_micro_organism_test_id) {
  ...
  function antibiotic_test_update($antibiotic_id,$micro_organism_test_id,$antibiotic_test_id) {
    $antibiotic_test_post['antibiotic.antibiotic_id'] = $this->session->antibiotic_antibiotic_id;
    $antibiotic_test_post['micro_organism_test.micro_organism_test_id'] = $this->session->micro_organism_test_micro_organism_test_id;
  ...
  function antibiotic_test_get_records($antibiotic_id,$micro_organism_test_id,$antibiotic_test_id) {
    ...
    antibiotic_test.antibiotic_id AS antibiotic_test_antibiotic_id, antibiotic_test.antibiotic_result AS antibiotic_test_antibiotic_result,
    antibiotic_test.antibiotic_test_id AS antibiotic_test_antibiotic_test_id, antibiotic_test.micro_organism_test_id AS antibiotic_test_micro_organism_test_id,
