<?php class Marital_info_model extends CI_Model {
  function marital_info_create($bb_external_patient_patient_id,$patient_patient_id) {
    $marital_info_post = [];
  ...
  function marital_info_update($patient_id,$patient_id,$marital_history_id) {
    $marital_info_post['bb_external_patient.patient_id'] = $this->session->bb_external_patient_patient_id;
    $marital_info_post['patient.patient_id'] = $this->session->patient_patient_id;
  ...
  function marital_info_get_records($patient_id,$patient_id,$marital_history_id) {
    ...
    marital_info.consanguinous AS marital_info_consanguinous, marital_info.marital_history_id AS marital_info_marital_history_id,
    marital_info.marital_life AS marital_info_marital_life, marital_info.marital_status AS marital_info_marital_status,
    marital_info.patient_id AS marital_info_patient_id')->from('marital_info');
