<?php class Area_model extends CI_Model {
  function area_create($area_types_area_type_id,$department_department_id) {
    $area_post = [];
  ...
  function area_update($area_type_id,$department_id,$area_id) {
    $area_post['area_types.area_type_id'] = $this->session->area_types_area_type_id;
    $area_post['department.department_id'] = $this->session->department_department_id;
  ...
  function area_get_records($area_type_id,$department_id,$area_id) {
    ...
    $this->db->select('area_types.area_type_id AS area_area_type_id, department.department_id AS area_department_id,
    area.area_id AS area_area_id, area.area_name AS area_area_name,
    area.area_type_id AS area_area_type_id, area.beds AS area_beds,
    area.department_id AS area_department_id, area.lab_report_staff_id AS area_lab_report_staff_id,
