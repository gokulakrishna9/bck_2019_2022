<?php class Attendance_model extends CI_Model {
  function attendance_create($roaster_roaster_id) {
    $attendance_post = [];
  ...
  function attendance_update($roaster_id,$attendance_id) {
    $attendance_post['roaster.roaster_id'] = $this->session->roaster_roaster_id;
  ...
  function attendance_get_records($roaster_id,$attendance_id) {
