<?php class Test_model extends CI_Model {
  function test_create($test_group_group_id,$test_order_order_id,$test_sample_sample_id,$test_master_test_master_id) {
    $test_post = [];
  ...
  function test_update($group_id,$order_id,$sample_id,$test_master_id,$test_id) {
    $test_post['test_group.group_id'] = $this->session->test_group_group_id;
    $test_post['test_order.order_id'] = $this->session->test_order_order_id;
    $test_post['test_sample.sample_id'] = $this->session->test_sample_sample_id;
    $test_post['test_master.test_master_id'] = $this->session->test_master_test_master_id;
  ...
  function test_get_records($group_id,$order_id,$sample_id,$test_master_id,$test_id) {
    ...
    $this->db->select('test_group.group_id AS test_group_id, test_order.order_id AS test_order_id,
    test_sample.sample_id AS test_sample_id, test_master.test_master_id AS test_test_master_id,
    test.group_id AS test_group_id, test.order_id AS test_order_id,
    test.reported_date_time AS test_reported_date_time, test.sample_id AS test_sample_id,
    test.temp_test_id AS test_temp_test_id, test.test_approved_by AS test_test_approved_by,
    test.test_date_time AS test_test_date_time, test.test_done_by AS test_test_done_by,
    test.test_id AS test_test_id, test.test_master_id AS test_test_master_id,
    test.test_range_id AS test_test_range_id, test.test_result AS test_test_result,
    test.test_result_binary AS test_test_result_binary, test.test_result_text AS test_test_result_text,
    test.test_status AS test_test_status')->from('test');
