<?php class Obstetric_history_model extends CI_Model {
  function obstetric_history_create($bb_external_patient_patient_id,$patient_patient_id) {
  ...
  function obstetric_history_update($patient_id,$patient_id,$obstetric_history_id) {
    $obstetric_history_post['bb_external_patient.patient_id'] = $this->session->bb_external_patient_patient_id;
    $obstetric_history_post['patient.patient_id'] = $this->session->patient_patient_id;
  ...
  function obstetric_history_get_records($patient_id,$patient_id,$obstetric_history_id) {
    ...
    obstetric_history.apgar AS obstetric_history_apgar, obstetric_history.birth_weight AS obstetric_history_birth_weight,
    obstetric_history.booking_status AS obstetric_history_booking_status, obstetric_history.cause_of_death AS obstetric_history_cause_of_death,
    obstetric_history.delivery_mode AS obstetric_history_delivery_mode, obstetric_history.dob AS obstetric_history_dob,
    obstetric_history.dod AS obstetric_history_dod, obstetric_history.edd AS obstetric_history_edd,
    obstetric_history.gestation AS obstetric_history_gestation, obstetric_history.lmp AS obstetric_history_lmp,
    ...
    obstetric_history.obstetric_history_id AS obstetric_history_obstetric_history_id, obstetric_history.outcome AS obstetric_history_outcome,
    obstetric_history.patient_id AS obstetric_history_patient_id, obstetric_history.placenta AS obstetric_history_placenta,
    obstetric_history.pregnancy_number AS obstetric_history_pregnancy_number, obstetric_history.sex AS obstetric_history_sex,
    obstetric_history.suture_removal_date AS obstetric_history_suture_removal_date')->from('obstetric_history');
