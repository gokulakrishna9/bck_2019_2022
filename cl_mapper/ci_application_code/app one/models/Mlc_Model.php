<?php class Mlc_model extends CI_Model {
  ...
  function mlc_get_records($visit_id) {
    ...
    $this->db->select('mlc.brought_by AS mlc_brought_by, mlc.declaration_required AS mlc_declaration_required,
    mlc.mlc_id AS mlc_mlc_id, mlc.mlc_number AS mlc_mlc_number,
    mlc.mlc_number_manual AS mlc_mlc_number_manual, mlc.pc_number AS mlc_pc_number,
    mlc.police_intimation AS mlc_police_intimation, mlc.ps_name AS mlc_ps_name,
    mlc.visit_id AS mlc_visit_id')->from('mlc');
