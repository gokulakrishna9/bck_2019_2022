<?php class Helpline_call_group_model extends CI_Model {
  ...
  function helpline_call_group_update($call_group_id) {
  ...
  function helpline_call_group_get_records($call_group_id) {
    ...
    $this->db->select('helpline_call_group.call_group_id AS helpline_call_group_call_group_id, helpline_call_group.created_by AS helpline_call_group_created_by,
    helpline_call_group.group_datetime AS helpline_call_group_group_datetime, helpline_call_group.group_name AS helpline_call_group_group_name')->from('helpline_call_group');
