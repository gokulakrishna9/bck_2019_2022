<?php class District_model extends CI_Model {
  function district_create($state_state_id,$state_codes_state_id) {
    $district_post = [];
  ...
  function district_update($state_id,$state_id,$district_id) {
    $district_post['state.state_id'] = $this->session->state_state_id;
    $district_post['state_codes.state_id'] = $this->session->state_codes_state_id;
  ...
  function district_get_records($state_id,$state_id,$district_id) {
    ...
    district.district AS district_district, district.district_id AS district_district_id,
