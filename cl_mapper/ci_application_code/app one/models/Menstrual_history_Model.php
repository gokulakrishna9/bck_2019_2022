<?php class Menstrual_history_model extends CI_Model {
  function menstrual_history_create($mlc_visit_id,$patient_visit_visit_id) {
  ...
  function menstrual_history_update($visit_id,$visit_id,$menstrual_history_id) {
    $menstrual_history_post['mlc.visit_id'] = $this->session->mlc_visit_id;
    $menstrual_history_post['patient_visit.visit_id'] = $this->session->patient_visit_visit_id;
  ...
  function menstrual_history_get_records($visit_id,$visit_id,$menstrual_history_id) {
    ...
    menstrual_history.cycle AS menstrual_history_cycle, menstrual_history.dysmenorrhea AS menstrual_history_dysmenorrhea,
    menstrual_history.flow_amount AS menstrual_history_flow_amount, menstrual_history.menstrual_history_id AS menstrual_history_menstrual_history_id,
    menstrual_history.regularity AS menstrual_history_regularity, menstrual_history.visit_id AS menstrual_history_visit_id')->from('menstrual_history');
