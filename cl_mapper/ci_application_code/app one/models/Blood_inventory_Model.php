<?php class Blood_inventory_model extends CI_Model {
  function blood_inventory_create($bb_donation_donation_id,$hospital_hospital_id,$staff_previous_hospital_hospital_id,$bb_status_status_id) {
  ...
  function blood_inventory_update($donation_id,$hospital_id,$hospital_id,$status_id,$inventory_id) {
    $blood_inventory_post['bb_donation.donation_id'] = $this->session->bb_donation_donation_id;
    $blood_inventory_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $blood_inventory_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
    $blood_inventory_post['bb_status.status_id'] = $this->session->bb_status_status_id;
  ...
  function blood_inventory_get_records($donation_id,$hospital_id,$hospital_id,$status_id,$inventory_id) {
    ...
    $this->db->select('bb_donation.donation_id AS blood_inventory_donation_id, hospital.hospital_id AS blood_inventory_hospital_id,
    staff_previous_hospital.hospital_id AS blood_inventory_hospital_id, bb_status.status_id AS blood_inventory_status_id,
    blood_inventory.component_perparation_time AS blood_inventory_component_perparation_time, blood_inventory.component_type AS blood_inventory_component_type,
    blood_inventory.created_by AS blood_inventory_created_by, blood_inventory.datetime AS blood_inventory_datetime,
    blood_inventory.discarded_by AS blood_inventory_discarded_by, blood_inventory.donation_id AS blood_inventory_donation_id,
    blood_inventory.expiry_date AS blood_inventory_expiry_date, blood_inventory.hospital_id AS blood_inventory_hospital_id,
    blood_inventory.inv_status AS blood_inventory_inv_status, blood_inventory.inventory_id AS blood_inventory_inventory_id,
    blood_inventory.notes AS blood_inventory_notes, blood_inventory.status_id AS blood_inventory_status_id,
    blood_inventory.volume AS blood_inventory_volume')->from('blood_inventory');
