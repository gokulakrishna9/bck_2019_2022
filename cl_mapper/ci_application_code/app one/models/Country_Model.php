<?php class Country_model extends CI_Model {
  ...
  function country_update($country_id) {
  ...
  function country_get_records($country_id) {
    ...
    $this->db->select('country.country AS country_country, country.country_id AS country_country_id')->from('country');
