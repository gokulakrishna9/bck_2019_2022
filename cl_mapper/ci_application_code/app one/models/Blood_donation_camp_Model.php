<?php class Blood_donation_camp_model extends CI_Model {
  function blood_donation_camp_create($hospital_hospital_id,$staff_previous_hospital_hospital_id) {
  ...
  function blood_donation_camp_update($hospital_id,$hospital_id,$camp_id) {
    $blood_donation_camp_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $blood_donation_camp_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function blood_donation_camp_get_records($hospital_id,$hospital_id,$camp_id) {
    ...
    blood_donation_camp.hospital_id AS blood_donation_camp_hospital_id, blood_donation_camp.location AS blood_donation_camp_location')->from('blood_donation_camp');
