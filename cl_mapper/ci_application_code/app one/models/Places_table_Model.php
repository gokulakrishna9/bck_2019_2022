<?php class Places_table_model extends CI_Model {
  ...
  function places_table_update($place_id) {
  ...
  function places_table_get_records($place_id) {
    ...
    $this->db->select('places_table.col_change AS places_table_col_change, places_table.country_code AS places_table_country_code,
    places_table.place_code AS places_table_place_code, places_table.place_date AS places_table_place_date,
    places_table.place_function AS places_table_place_function, places_table.place_iata AS places_table_place_iata,
    places_table.place_id AS places_table_place_id, places_table.place_name AS places_table_place_name,
    places_table.place_name_without_diacritics AS places_table_place_name_without_diacritics, places_table.place_status AS places_table_place_status,
    places_table.state_code AS places_table_state_code, places_table.subsidiary_loc AS places_table_subsidiary_loc,
