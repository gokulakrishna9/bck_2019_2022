<?php class Antibiotic_model extends CI_Model {
  function antibiotic_create($hospital_hospital_id,$staff_previous_hospital_hospital_id) {
    $antibiotic_post = [];
  ...
  function antibiotic_update($hospital_id,$hospital_id,$antibiotic_id) {
    $antibiotic_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $antibiotic_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function antibiotic_get_records($hospital_id,$hospital_id,$antibiotic_id) {
    ...
    antibiotic.antibiotic AS antibiotic_antibiotic, antibiotic.antibiotic_id AS antibiotic_antibiotic_id,
