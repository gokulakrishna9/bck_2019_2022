<?php class Procedure_plan_model extends CI_Model {
  function procedure_plan_create($procedure_procedure_id,$mlc_visit_id,$patient_visit_visit_id) {
    $procedure_plan_post = [];
  ...
  function procedure_plan_update($procedure_id,$visit_id,$visit_id,$procedure_plan_id) {
    $procedure_plan_post['procedure.procedure_id'] = $this->session->procedure_procedure_id;
    $procedure_plan_post['mlc.visit_id'] = $this->session->mlc_visit_id;
    $procedure_plan_post['patient_visit.visit_id'] = $this->session->patient_visit_visit_id;
  ...
  function procedure_plan_get_records($procedure_id,$visit_id,$visit_id,$procedure_plan_id) {
    ...
    $this->db->select('procedure.procedure_id AS procedure_plan_procedure_id, mlc.visit_id AS procedure_plan_visit_id,
    patient_visit.visit_id AS procedure_plan_visit_id, procedure_plan.plan_date AS procedure_plan_plan_date,
    procedure_plan.procedure_id AS procedure_plan_procedure_id, procedure_plan.procedure_plan_id AS procedure_plan_procedure_plan_id,
    procedure_plan.status AS procedure_plan_status, procedure_plan.visit_id AS procedure_plan_visit_id')->from('procedure_plan');
