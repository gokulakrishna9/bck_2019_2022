<?php class Api_updates_model extends CI_Model {
  ...
  function api_updates_update($api_id) {
  ...
  function api_updates_get_records($api_id) {
    ...
    api_updates.key_name AS api_updates_key_name, api_updates.last_updated_id AS api_updates_last_updated_id,
    api_updates.table_name AS api_updates_table_name')->from('api_updates');
