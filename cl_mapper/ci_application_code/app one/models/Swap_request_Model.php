<?php class Swap_request_model extends CI_Model {
  ...
  function swap_request_update($swap_id) {
  ...
  function swap_request_get_records($swap_id) {
    ...
    $this->db->select('swap_request.request_timestamp AS swap_request_request_timestamp, swap_request.roaster_id_accepted AS swap_request_roaster_id_accepted,
    swap_request.roaster_id_requested AS swap_request_roaster_id_requested, swap_request.shift_id_requested AS swap_request_shift_id_requested,
    swap_request.swap_id AS swap_request_swap_id, swap_request.swap_status AS swap_request_swap_status')->from('swap_request');
