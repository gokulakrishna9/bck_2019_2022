<?php class Patient_model extends CI_Model {
  function patient_create($hospital_hospital_id,$staff_previous_hospital_hospital_id,$id_proof_type_id_proof_type_id,$occupation_occupation_id) {
    $patient_post = [];
  ...
  function patient_update($hospital_id,$hospital_id,$id_proof_type_id,$occupation_id,$patient_id) {
    $patient_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $patient_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
    $patient_post['id_proof_type.id_proof_type_id'] = $this->session->id_proof_type_id_proof_type_id;
    $patient_post['occupation.occupation_id'] = $this->session->occupation_occupation_id;
  ...
  function patient_get_records($hospital_id,$hospital_id,$id_proof_type_id,$occupation_id,$patient_id) {
    ...
    $this->db->select('hospital.hospital_id AS patient_hospital_id, staff_previous_hospital.hospital_id AS patient_hospital_id,
    id_proof_type.id_proof_type_id AS patient_id_proof_type_id, occupation.occupation_id AS patient_occupation_id,
    patient.address AS patient_address, patient.age_days AS patient_age_days,
    patient.age_months AS patient_age_months, patient.age_years AS patient_age_years,
    patient.alt_phone AS patient_alt_phone, patient.bc_no AS patient_bc_no,
    patient.birth_weight AS patient_birth_weight, patient.blood_group AS patient_blood_group,
    patient.congenital_anomalies AS patient_congenital_anomalies, patient.country_code AS patient_country_code,
    patient.delivery_location AS patient_delivery_location, patient.delivery_location_type AS patient_delivery_location_type,
    patient.delivery_mode AS patient_delivery_mode, patient.delivery_place AS patient_delivery_place,
    patient.delivery_plan AS patient_delivery_plan, patient.district_id AS patient_district_id,
    patient.dob AS patient_dob, patient.education_level AS patient_education_level,
    patient.education_qualification AS patient_education_qualification, patient.father_name AS patient_father_name,
    patient.first_name AS patient_first_name, patient.gender AS patient_gender,
    patient.gestation AS patient_gestation, patient.gestation_type AS patient_gestation_type,
    patient.hospital_id AS patient_hospital_id, patient.hospital_type AS patient_hospital_type,
    patient.id_proof_number AS patient_id_proof_number, patient.id_proof_type_id AS patient_id_proof_type_id,
    patient.identification_marks AS patient_identification_marks, patient.insert_by_user_id AS patient_insert_by_user_id,
    patient.insert_datetime AS patient_insert_datetime, patient.last_name AS patient_last_name,
    patient.middle_name AS patient_middle_name, patient.mother_name AS patient_mother_name,
    patient.mr_no AS patient_mr_no, patient.occupation_id AS patient_occupation_id,
    patient.patient_id AS patient_patient_id, patient.patient_id_manual AS patient_patient_id_manual,
    patient.phone AS patient_phone, patient.place AS patient_place,
    patient.spouse_name AS patient_spouse_name, patient.state_code AS patient_state_code,
    patient.temp_patient_id AS patient_temp_patient_id, patient.update_by_user_id AS patient_update_by_user_id,
    patient.update_datetime AS patient_update_datetime')->from('patient');
