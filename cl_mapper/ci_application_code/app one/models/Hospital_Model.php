<?php class Hospital_model extends CI_Model {
  function hospital_create($village_town_village_town_id) {
    $hospital_post = [];
  ...
  function hospital_update($village_town_id,$hospital_id) {
    $hospital_post['village_town.village_town_id'] = $this->session->village_town_village_town_id;
  ...
  function hospital_get_records($village_town_id,$hospital_id) {
    ...
    $this->db->select('village_town.village_town_id AS hospital_village_town_id, hospital.description AS hospital_description,
    hospital.district AS hospital_district, hospital.hospital AS hospital_hospital,
    hospital.hospital_id AS hospital_hospital_id, hospital.hospital_short_name AS hospital_hospital_short_name,
    hospital.hospital_type_id AS hospital_hospital_type_id, hospital.logo AS hospital_logo,
    hospital.place AS hospital_place, hospital.state AS hospital_state,
    hospital.type1 AS hospital_type1, hospital.type2 AS hospital_type2,
    hospital.type3 AS hospital_type3, hospital.type4 AS hospital_type4,
    hospital.type5 AS hospital_type5, hospital.type6 AS hospital_type6,
    hospital.village_town_id AS hospital_village_town_id')->from('hospital');
