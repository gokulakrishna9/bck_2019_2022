<?php class Id_proof_type_model extends CI_Model {
  ...
  function id_proof_type_update($id_proof_type_id) {
  ...
  function id_proof_type_get_records($id_proof_type_id) {
    ...
    $this->db->select('id_proof_type.id_proof_type AS id_proof_type_id_proof_type, id_proof_type.id_proof_type_id AS id_proof_type_id_proof_type_id')->from('id_proof_type');
