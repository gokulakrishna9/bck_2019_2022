<?php class Audiology_model extends CI_Model {
  function audiology_create($staff_staff_id) {
    $audiology_post = [];
  ...
  function audiology_update($staff_id,$aud_test_id) {
    $audiology_post['staff.staff_id'] = $this->session->staff_staff_id;
  ...
  function audiology_get_records($staff_id,$aud_test_id) {
    ...
    audiology.date_of_test AS audiology_date_of_test, audiology.ip_no AS audiology_ip_no,
    audiology.oael_outcome AS audiology_oael_outcome, audiology.oaer_outcome AS audiology_oaer_outcome,
    audiology.remarks AS audiology_remarks, audiology.staff_id AS audiology_staff_id,
    audiology.test_no AS audiology_test_no, audiology.type_of_test AS audiology_type_of_test')->from('audiology');
