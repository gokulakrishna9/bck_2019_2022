<?php class Visit_name_model extends CI_Model {
  ...
  function visit_name_update($visit_name_id) {
  ...
  function visit_name_get_records($visit_name_id) {
    ...
    $this->db->select('visit_name.visit_name AS visit_name_visit_name, visit_name.visit_name_id AS visit_name_visit_name_id')->from('visit_name');
