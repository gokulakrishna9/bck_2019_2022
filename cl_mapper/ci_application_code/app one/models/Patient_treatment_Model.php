<?php class Patient_treatment_model extends CI_Model {
  ...
  function patient_treatment_update($treatment_id) {
  ...
  function patient_treatment_get_records($treatment_id) {
    ...
    $this->db->select('patient_treatment.duration AS patient_treatment_duration, patient_treatment.notes AS patient_treatment_notes,
    patient_treatment.treatment AS patient_treatment_treatment, patient_treatment.treatment_date AS patient_treatment_treatment_date,
    patient_treatment.treatment_id AS patient_treatment_treatment_id, patient_treatment.treatment_time AS patient_treatment_treatment_time,
    patient_treatment.treatment_type AS patient_treatment_treatment_type, patient_treatment.visit_id AS patient_treatment_visit_id')->from('patient_treatment');
