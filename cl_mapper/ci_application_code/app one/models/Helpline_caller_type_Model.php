<?php class Helpline_caller_type_model extends CI_Model {
  ...
  function helpline_caller_type_update($caller_type_id) {
  ...
  function helpline_caller_type_get_records($caller_type_id) {
    ...
    $this->db->select('helpline_caller_type.caller_type AS helpline_caller_type_caller_type, helpline_caller_type.caller_type_id AS helpline_caller_type_caller_type_id,
