<?php class Unit_model extends CI_Model {
  function unit_create($department_department_id) {
    $unit_post = [];
  ...
  function unit_update($department_id,$unit_id) {
    $unit_post['department.department_id'] = $this->session->department_department_id;
  ...
  function unit_get_records($department_id,$unit_id) {
    ...
    $this->db->select('department.department_id AS unit_department_id, unit.beds AS unit_beds,
    unit.department_id AS unit_department_id, unit.lab_report_staff_id AS unit_lab_report_staff_id,
    unit.temp_unit_id AS unit_temp_unit_id, unit.unit_head_staff_id AS unit_unit_head_staff_id,
    unit.unit_id AS unit_unit_id, unit.unit_name AS unit_unit_name')->from('unit');
