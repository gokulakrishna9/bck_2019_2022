<?php class Bb_replacement_patient_model extends CI_Model {
  function bb_replacement_patient_create($hospital_hospital_id,$staff_previous_hospital_hospital_id) {
  ...
  function bb_replacement_patient_update($hospital_id,$hospital_id,$replacement_patient_id) {
    $bb_replacement_patient_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $bb_replacement_patient_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function bb_replacement_patient_get_records($hospital_id,$hospital_id,$replacement_patient_id) {
    ...
    bb_replacement_patient.blood_group AS bb_replacement_patient_blood_group, bb_replacement_patient.hospital_id AS bb_replacement_patient_hospital_id,
    bb_replacement_patient.ip_number AS bb_replacement_patient_ip_number, bb_replacement_patient.name AS bb_replacement_patient_name,
    bb_replacement_patient.replacement_patient_id AS bb_replacement_patient_replacement_patient_id, bb_replacement_patient.ward_unit AS bb_replacement_patient_ward_unit')->from('bb_replacement_patient');
