<?php class Test_master_model extends CI_Model {
  function test_master_create($test_assay_assay_id,$hospital_hospital_id,$staff_previous_hospital_hospital_id,$test_area_test_area_id,$test_method_test_method_id) {
    $test_master_post = [];
  ...
  function test_master_update($assay_id,$hospital_id,$hospital_id,$test_area_id,$test_method_id,$test_master_id) {
    $test_master_post['test_assay.assay_id'] = $this->session->test_assay_assay_id;
    $test_master_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $test_master_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
    $test_master_post['test_area.test_area_id'] = $this->session->test_area_test_area_id;
  ...
  function test_master_get_records($assay_id,$hospital_id,$hospital_id,$test_area_id,$test_method_id,$test_master_id) {
    ...
    $this->db->select('test_assay.assay_id AS test_master_assay_id, hospital.hospital_id AS test_master_hospital_id,
    staff_previous_hospital.hospital_id AS test_master_hospital_id, test_area.test_area_id AS test_master_test_area_id,
    test_method.test_method_id AS test_master_test_method_id, test_master.assay_id AS test_master_assay_id,
    test_master.availability AS test_master_availability, test_master.binary_negative AS test_master_binary_negative,
    test_master.binary_positive AS test_master_binary_positive, test_master.binary_result AS test_master_binary_result,
    test_master.comments AS test_master_comments, test_master.hospital_id AS test_master_hospital_id,
    test_master.interpretation AS test_master_interpretation, test_master.level AS test_master_level,
    test_master.nabl AS test_master_nabl, test_master.numeric_result AS test_master_numeric_result,
    test_master.numeric_result_unit AS test_master_numeric_result_unit, test_master.temp_test_master_id AS test_master_temp_test_master_id,
    test_master.test_area_id AS test_master_test_area_id, test_master.test_master_id AS test_master_test_master_id,
    test_master.test_method_id AS test_master_test_method_id, test_master.test_name AS test_master_test_name,
    test_master.text_range AS test_master_text_range, test_master.text_result AS test_master_text_result')->from('test_master');
