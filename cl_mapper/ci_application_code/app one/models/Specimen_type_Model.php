<?php class Specimen_type_model extends CI_Model {
  function specimen_type_create($hospital_hospital_id,$staff_previous_hospital_hospital_id) {
    $specimen_type_post = [];
  ...
  function specimen_type_update($hospital_id,$hospital_id,$specimen_type_id) {
    $specimen_type_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $specimen_type_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function specimen_type_get_records($hospital_id,$hospital_id,$specimen_type_id) {
    ...
    specimen_type.hospital_id AS specimen_type_hospital_id, specimen_type.specimen_type AS specimen_type_specimen_type,
    specimen_type.specimen_type_id AS specimen_type_specimen_type_id, specimen_type.temp_specimen_type_id AS specimen_type_temp_specimen_type_id')->from('specimen_type');
