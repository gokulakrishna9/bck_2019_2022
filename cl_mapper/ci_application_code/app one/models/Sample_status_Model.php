<?php class Sample_status_model extends CI_Model {
  ...
  function sample_status_update($sample_status_id) {
  ...
  function sample_status_get_records($sample_status_id) {
    ...
    $this->db->select('sample_status.sample_status AS sample_status_sample_status, sample_status.sample_status_id AS sample_status_sample_status_id')->from('sample_status');
