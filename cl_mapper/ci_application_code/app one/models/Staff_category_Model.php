<?php class Staff_category_model extends CI_Model {
  ...
  function staff_category_update($staff_category_id) {
  ...
  function staff_category_get_records($staff_category_id) {
    ...
    $this->db->select('staff_category.seniority AS staff_category_seniority, staff_category.staff_category AS staff_category_staff_category,
    staff_category.staff_category_id AS staff_category_staff_category_id')->from('staff_category');
