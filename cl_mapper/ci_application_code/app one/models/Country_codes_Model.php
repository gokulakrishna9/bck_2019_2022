<?php class Country_codes_model extends CI_Model {
  ...
  function country_codes_update($country_id) {
  ...
  function country_codes_get_records($country_id) {
    ...
    $this->db->select('country_codes.country AS country_codes_country, country_codes.country_id AS country_codes_country_id,
