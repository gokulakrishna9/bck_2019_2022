<?php class Helpline_call_category_model extends CI_Model {
  ...
  function helpline_call_category_update($call_category_id) {
  ...
  function helpline_call_category_get_records($call_category_id) {
    ...
    $this->db->select('helpline_call_category.call_category AS helpline_call_category_call_category, helpline_call_category.call_category_id AS helpline_call_category_call_category_id,
