<?php class Test_range_model extends CI_Model {
  function test_range_create($test_master_test_master_id) {
    $test_range_post = [];
  ...
  function test_range_update($test_master_id,$test_range_id) {
    $test_range_post['test_master.test_master_id'] = $this->session->test_master_test_master_id;
  ...
  function test_range_get_records($test_master_id,$test_range_id) {
    ...
    $this->db->select('test_master.test_master_id AS test_range_test_master_id, test_range.age_type AS test_range_age_type,
    test_range.from_day AS test_range_from_day, test_range.from_month AS test_range_from_month,
    test_range.from_year AS test_range_from_year, test_range.gender AS test_range_gender,
    test_range.max AS test_range_max, test_range.min AS test_range_min,
    test_range.range_active AS test_range_range_active, test_range.range_text AS test_range_range_text,
    test_range.range_type AS test_range_range_type, test_range.temp_test_range_id AS test_range_temp_test_range_id,
    test_range.test_master_id AS test_range_test_master_id, test_range.test_range_id AS test_range_test_range_id,
    test_range.to_day AS test_range_to_day, test_range.to_month AS test_range_to_month,
    test_range.to_year AS test_range_to_year')->from('test_range');
