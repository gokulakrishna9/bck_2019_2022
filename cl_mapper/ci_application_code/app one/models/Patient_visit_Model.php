<?php class Patient_visit_model extends CI_Model {
  function patient_visit_create($department_department_id,$hospital_hospital_id,$staff_previous_hospital_hospital_id,$insurance_insurance_id,$bb_external_patient_patient_id,$patient_patient_id,$visit_name_visit_name_id) {
    $patient_visit_post = [];
  ...
  function patient_visit_update($department_id,$hospital_id,$hospital_id,$insurance_id,$patient_id,$patient_id,$visit_name_id,$visit_id) {
    $patient_visit_post['department.department_id'] = $this->session->department_department_id;
    $patient_visit_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $patient_visit_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
    $patient_visit_post['insurance.insurance_id'] = $this->session->insurance_insurance_id;
  ...
  function patient_visit_get_records($department_id,$hospital_id,$hospital_id,$insurance_id,$patient_id,$patient_id,$visit_name_id,$visit_id) {
    ...
    $this->db->select('department.department_id AS patient_visit_department_id, hospital.hospital_id AS patient_visit_hospital_id,
    staff_previous_hospital.hospital_id AS patient_visit_hospital_id, insurance.insurance_id AS patient_visit_insurance_id,
    bb_external_patient.patient_id AS patient_visit_patient_id, patient.patient_id AS patient_visit_patient_id,
    visit_name.visit_name_id AS patient_visit_visit_name_id, patient_visit.admit_date AS patient_visit_admit_date,
    patient_visit.admit_id AS patient_visit_admit_id, patient_visit.admit_time AS patient_visit_admit_time,
    patient_visit.admit_weight AS patient_visit_admit_weight, patient_visit.advise AS patient_visit_advise,
    patient_visit.area AS patient_visit_area, patient_visit.arrival_mode AS patient_visit_arrival_mode,
    patient_visit.clinical_findings AS patient_visit_clinical_findings, patient_visit.cns AS patient_visit_cns,
    patient_visit.cvs AS patient_visit_cvs, patient_visit.cxr AS patient_visit_cxr,
    patient_visit.dbp AS patient_visit_dbp, patient_visit.decision AS patient_visit_decision,
    patient_visit.department_id AS patient_visit_department_id, patient_visit.discharge_weight AS patient_visit_discharge_weight,
    patient_visit.doctor_id AS patient_visit_doctor_id, patient_visit.family_history AS patient_visit_family_history,
    patient_visit.final_diagnosis AS patient_visit_final_diagnosis, patient_visit.hosp_file_no AS patient_visit_hosp_file_no,
    patient_visit.hospital_id AS patient_visit_hospital_id, patient_visit.icd_10 AS patient_visit_icd_10,
    patient_visit.icd_10_ext AS patient_visit_icd_10_ext, patient_visit.insert_by_user_id AS patient_visit_insert_by_user_id,
    patient_visit.insert_datetime AS patient_visit_insert_datetime, patient_visit.insurance_case AS patient_visit_insurance_case,
    patient_visit.insurance_id AS patient_visit_insurance_id, patient_visit.insurance_no AS patient_visit_insurance_no,
    patient_visit.ip_file_received AS patient_visit_ip_file_received, patient_visit.mlc AS patient_visit_mlc,
    patient_visit.nurse AS patient_visit_nurse, patient_visit.outcome AS patient_visit_outcome,
    patient_visit.outcome_date AS patient_visit_outcome_date, patient_visit.outcome_time AS patient_visit_outcome_time,
    patient_visit.pa AS patient_visit_pa, patient_visit.past_history AS patient_visit_past_history,
    patient_visit.patient_id AS patient_visit_patient_id, patient_visit.presenting_complaints AS patient_visit_presenting_complaints,
    patient_visit.provisional_diagnosis AS patient_visit_provisional_diagnosis, patient_visit.pulse_rate AS patient_visit_pulse_rate,
    patient_visit.refereal_hospital_id AS patient_visit_refereal_hospital_id, patient_visit.respiratory_rate AS patient_visit_respiratory_rate,
    patient_visit.rs AS patient_visit_rs, patient_visit.sbp AS patient_visit_sbp,
    patient_visit.temp_visit_id AS patient_visit_temp_visit_id, patient_visit.temperature AS patient_visit_temperature,
    patient_visit.unit AS patient_visit_unit, patient_visit.update_by_user_id AS patient_visit_update_by_user_id,
    patient_visit.update_datetime AS patient_visit_update_datetime, patient_visit.visit_id AS patient_visit_visit_id,
    patient_visit.visit_name_id AS patient_visit_visit_name_id, patient_visit.visit_type AS patient_visit_visit_type')->from('patient_visit');
