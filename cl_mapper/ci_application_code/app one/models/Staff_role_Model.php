<?php class Staff_role_model extends CI_Model {
  ...
  function staff_role_update($staff_role_id) {
  ...
  function staff_role_get_records($staff_role_id) {
    ...
    $this->db->select('staff_role.staff_role AS staff_role_staff_role, staff_role.staff_role_id AS staff_role_staff_role_id')->from('staff_role');
