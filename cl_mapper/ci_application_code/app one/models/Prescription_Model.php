<?php class Prescription_model extends CI_Model {
  function prescription_create($item_item_id,$item_master_item_id,$unit_unit_id,$mlc_visit_id,$patient_visit_visit_id) {
    $prescription_post = [];
  ...
  function prescription_update($item_id,$item_id,$unit_id,$visit_id,$visit_id,$prescription_id) {
    $prescription_post['item.item_id'] = $this->session->item_item_id;
    $prescription_post['item_master.item_id'] = $this->session->item_master_item_id;
    $prescription_post['unit.unit_id'] = $this->session->unit_unit_id;
    $prescription_post['mlc.visit_id'] = $this->session->mlc_visit_id;
  ...
  function prescription_get_records($item_id,$item_id,$unit_id,$visit_id,$visit_id,$prescription_id) {
    ...
    $this->db->select('item.item_id AS prescription_item_id, item_master.item_id AS prescription_item_id,
    unit.unit_id AS prescription_unit_id, mlc.visit_id AS prescription_visit_id,
    patient_visit.visit_id AS prescription_visit_id, prescription.afternoon AS prescription_afternoon,
    prescription.duration AS prescription_duration, prescription.evening AS prescription_evening,
    prescription.frequency AS prescription_frequency, prescription.item_id AS prescription_item_id,
    prescription.morning AS prescription_morning, prescription.prescription_id AS prescription_prescription_id,
    prescription.quantity AS prescription_quantity, prescription.status AS prescription_status,
    prescription.unit_id AS prescription_unit_id, prescription.visit_id AS prescription_visit_id')->from('prescription');
