<?php class User_hospital_link_model extends CI_Model {
  function user_hospital_link_create($hospital_hospital_id,$staff_previous_hospital_hospital_id,$bb_user_user_id,$user_user_id) {
  ...
  function user_hospital_link_update($hospital_id,$hospital_id,$user_id,$user_id,$link_id) {
    $user_hospital_link_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $user_hospital_link_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
    $user_hospital_link_post['bb_user.user_id'] = $this->session->bb_user_user_id;
    $user_hospital_link_post['user.user_id'] = $this->session->user_user_id;
  ...
  function user_hospital_link_get_records($hospital_id,$hospital_id,$user_id,$user_id,$link_id) {
    ...
    $this->db->select('hospital.hospital_id AS user_hospital_link_hospital_id, staff_previous_hospital.hospital_id AS user_hospital_link_hospital_id,
    bb_user.user_id AS user_hospital_link_user_id, user.user_id AS user_hospital_link_user_id,
    user_hospital_link.hospital_id AS user_hospital_link_hospital_id, user_hospital_link.link_id AS user_hospital_link_link_id,
    user_hospital_link.user_id AS user_hospital_link_user_id')->from('user_hospital_link');
