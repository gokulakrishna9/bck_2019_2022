<?php class Internal_transfer_model extends CI_Model {
  function internal_transfer_create($area_area_id,$department_department_id,$bb_user_user_id,$user_user_id,$mlc_visit_id,$patient_visit_visit_id) {
  ...
  function internal_transfer_update($area_id,$department_id,$user_id,$user_id,$visit_id,$visit_id,$transfer_id) {
    $internal_transfer_post['area.area_id'] = $this->session->area_area_id;
    $internal_transfer_post['department.department_id'] = $this->session->department_department_id;
    $internal_transfer_post['bb_user.user_id'] = $this->session->bb_user_user_id;
    $internal_transfer_post['user.user_id'] = $this->session->user_user_id;
  ...
  function internal_transfer_get_records($area_id,$department_id,$user_id,$user_id,$visit_id,$visit_id,$transfer_id) {
    ...
    $this->db->select('area.area_id AS internal_transfer_area_id, department.department_id AS internal_transfer_department_id,
    bb_user.user_id AS internal_transfer_user_id, user.user_id AS internal_transfer_user_id,
    mlc.visit_id AS internal_transfer_visit_id, patient_visit.visit_id AS internal_transfer_visit_id,
    internal_transfer.area_id AS internal_transfer_area_id, internal_transfer.department_id AS internal_transfer_department_id,
    internal_transfer.timestamp AS internal_transfer_timestamp, internal_transfer.transfer_date AS internal_transfer_transfer_date,
    internal_transfer.transfer_id AS internal_transfer_transfer_id, internal_transfer.transfer_time AS internal_transfer_transfer_time,
    internal_transfer.user_id AS internal_transfer_user_id, internal_transfer.visit_id AS internal_transfer_visit_id')->from('internal_transfer');
