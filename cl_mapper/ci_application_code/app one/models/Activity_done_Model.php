<?php class Activity_done_model extends CI_Model {
  function activity_done_create($facility_activity_activity_id,$bb_user_user_id,$user_user_id) {
    $activity_done_post = [];
  ...
  function activity_done_update($activity_id,$user_id,$user_id,$activity_done_id) {
    $activity_done_post['facility_activity.activity_id'] = $this->session->facility_activity_activity_id;
    $activity_done_post['bb_user.user_id'] = $this->session->bb_user_user_id;
    $activity_done_post['user.user_id'] = $this->session->user_user_id;
  ...
  function activity_done_get_records($activity_id,$user_id,$user_id,$activity_done_id) {
    ...
    activity_done.activity_id AS activity_done_activity_id, activity_done.comments AS activity_done_comments,
    activity_done.date AS activity_done_date, activity_done.datetime AS activity_done_datetime,
    activity_done.score AS activity_done_score, activity_done.time AS activity_done_time,
    activity_done.user_id AS activity_done_user_id')->from('activity_done');
