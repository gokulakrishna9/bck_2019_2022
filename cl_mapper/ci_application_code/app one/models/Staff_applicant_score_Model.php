<?php class Staff_applicant_score_model extends CI_Model {
  function staff_applicant_score_create($staff_applicant_applicant_id,$staff_recruitment_drive_drive_id,$staff_selection_parameter_parameter_id) {
  ...
  function staff_applicant_score_update($applicant_id,$drive_id,$parameter_id,$score_id) {
    $staff_applicant_score_post['staff_applicant.applicant_id'] = $this->session->staff_applicant_applicant_id;
    $staff_applicant_score_post['staff_recruitment_drive.drive_id'] = $this->session->staff_recruitment_drive_drive_id;
    $staff_applicant_score_post['staff_selection_parameter.parameter_id'] = $this->session->staff_selection_parameter_parameter_id;
  ...
  function staff_applicant_score_get_records($applicant_id,$drive_id,$parameter_id,$score_id) {
    ...
    $this->db->select('staff_applicant.applicant_id AS staff_applicant_score_applicant_id, staff_recruitment_drive.drive_id AS staff_applicant_score_drive_id,
    staff_selection_parameter.parameter_id AS staff_applicant_score_parameter_id, staff_applicant_score.applicant_id AS staff_applicant_score_applicant_id,
    staff_applicant_score.drive_id AS staff_applicant_score_drive_id, staff_applicant_score.parameter_id AS staff_applicant_score_parameter_id,
    staff_applicant_score.score AS staff_applicant_score_score, staff_applicant_score.score_id AS staff_applicant_score_score_id')->from('staff_applicant_score');
