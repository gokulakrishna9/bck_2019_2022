<?php class Village_town_model extends CI_Model {
  ...
  function village_town_update($village_town_id) {
  ...
  function village_town_get_records($village_town_id) {
    ...
    $this->db->select('village_town.village_town AS village_town_village_town, village_town.village_town_id AS village_town_village_town_id')->from('village_town');
