<?php class Bb_issued_inventory_model extends CI_Model {
  function bb_issued_inventory_create($blood_inventory_inventory_id,$blood_issue_issue_id) {
  ...
  function bb_issued_inventory_update($inventory_id,$issue_id,$issued_inventory_id) {
    $bb_issued_inventory_post['blood_inventory.inventory_id'] = $this->session->blood_inventory_inventory_id;
    $bb_issued_inventory_post['blood_issue.issue_id'] = $this->session->blood_issue_issue_id;
  ...
  function bb_issued_inventory_get_records($inventory_id,$issue_id,$issued_inventory_id) {
    ...
    $this->db->select('blood_inventory.inventory_id AS bb_issued_inventory_inventory_id, blood_issue.issue_id AS bb_issued_inventory_issue_id,
    bb_issued_inventory.inventory_id AS bb_issued_inventory_inventory_id, bb_issued_inventory.issue_id AS bb_issued_inventory_issue_id,
    bb_issued_inventory.issued_inventory_id AS bb_issued_inventory_issued_inventory_id')->from('bb_issued_inventory');
