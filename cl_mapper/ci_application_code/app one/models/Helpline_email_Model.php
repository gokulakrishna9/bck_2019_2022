<?php class Helpline_email_model extends CI_Model {
  function helpline_email_create($helpline_call_call_id,$bb_user_user_id,$user_user_id) {
    $helpline_email_post = [];
  ...
  function helpline_email_update($call_id,$user_id,$user_id,$helpline_email_id) {
    $helpline_email_post['helpline_call.call_id'] = $this->session->helpline_call_call_id;
    $helpline_email_post['bb_user.user_id'] = $this->session->bb_user_user_id;
    $helpline_email_post['user.user_id'] = $this->session->user_user_id;
  ...
  function helpline_email_get_records($call_id,$user_id,$user_id,$helpline_email_id) {
    ...
    user.user_id AS helpline_email_user_id, helpline_email.call_id AS helpline_email_call_id,
    helpline_email.cc_email AS helpline_email_cc_email, helpline_email.email_date_time AS helpline_email_email_date_time,
    helpline_email.greeting AS helpline_email_greeting, helpline_email.helpline_email_id AS helpline_email_helpline_email_id,
    helpline_email.note AS helpline_email_note, helpline_email.phone_shared AS helpline_email_phone_shared,
    helpline_email.to_email AS helpline_email_to_email, helpline_email.user_id AS helpline_email_user_id')->from('helpline_email');
