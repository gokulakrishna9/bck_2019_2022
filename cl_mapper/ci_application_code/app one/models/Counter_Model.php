<?php class Counter_model extends CI_Model {
  function counter_create($hospital_hospital_id,$staff_previous_hospital_hospital_id) {
    $counter_post = [];
  ...
  function counter_update($hospital_id,$hospital_id,$counter_id) {
    $counter_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $counter_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function counter_get_records($hospital_id,$hospital_id,$counter_id) {
    ...
    counter.count AS counter_count, counter.counter_id AS counter_counter_id,
