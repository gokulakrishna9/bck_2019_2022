<?php class Dosage_model extends CI_Model {
  ...
  function dosage_update($dosage_id) {
  ...
  function dosage_get_records($dosage_id) {
    ...
    $this->db->select('dosage.dosage AS dosage_dosage, dosage.dosage_id AS dosage_dosage_id,
    dosage.dosage_unit AS dosage_dosage_unit')->from('dosage');
