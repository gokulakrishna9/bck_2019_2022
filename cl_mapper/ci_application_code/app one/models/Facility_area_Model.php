<?php class Facility_area_model extends CI_Model {
  function facility_area_create($area_types_area_type_id,$department_department_id,$facility_facility_id) {
    $facility_area_post = [];
  ...
  function facility_area_update($area_type_id,$department_id,$facility_id,$facility_area_id) {
    $facility_area_post['area_types.area_type_id'] = $this->session->area_types_area_type_id;
    $facility_area_post['department.department_id'] = $this->session->department_department_id;
    $facility_area_post['facility.facility_id'] = $this->session->facility_facility_id;
  ...
  function facility_area_get_records($area_type_id,$department_id,$facility_id,$facility_area_id) {
    ...
    $this->db->select('area_types.area_type_id AS facility_area_area_type_id, department.department_id AS facility_area_department_id,
    facility.facility_id AS facility_area_facility_id, facility_area.area_name AS facility_area_area_name,
    facility_area.area_type_id AS facility_area_area_type_id, facility_area.department_id AS facility_area_department_id,
    facility_area.facility_area_id AS facility_area_facility_area_id, facility_area.facility_id AS facility_area_facility_id')->from('facility_area');
