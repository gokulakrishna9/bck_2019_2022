<?php class Test_sample_model extends CI_Model {
  function test_sample_create($test_order_order_id,$sample_status_sample_status_id,$specimen_type_specimen_type_id) {
    $test_sample_post = [];
  ...
  function test_sample_update($order_id,$sample_status_id,$specimen_type_id,$sample_id) {
    $test_sample_post['test_order.order_id'] = $this->session->test_order_order_id;
    $test_sample_post['sample_status.sample_status_id'] = $this->session->sample_status_sample_status_id;
    $test_sample_post['specimen_type.specimen_type_id'] = $this->session->specimen_type_specimen_type_id;
  ...
  function test_sample_get_records($order_id,$sample_status_id,$specimen_type_id,$sample_id) {
    ...
    $this->db->select('test_order.order_id AS test_sample_order_id, sample_status.sample_status_id AS test_sample_sample_status_id,
    specimen_type.specimen_type_id AS test_sample_specimen_type_id, test_sample.order_id AS test_sample_order_id,
    test_sample.sample_code AS test_sample_sample_code, test_sample.sample_container_type AS test_sample_sample_container_type,
    test_sample.sample_date_time AS test_sample_sample_date_time, test_sample.sample_id AS test_sample_sample_id,
    test_sample.sample_status_id AS test_sample_sample_status_id, test_sample.specimen_source AS test_sample_specimen_source,
    test_sample.specimen_type_id AS test_sample_specimen_type_id, test_sample.temp_sample_id AS test_sample_temp_sample_id')->from('test_sample');
