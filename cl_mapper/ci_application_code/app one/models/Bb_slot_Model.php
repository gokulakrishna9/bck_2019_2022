<?php class Bb_slot_model extends CI_Model {
  function bb_slot_create($hospital_hospital_id,$staff_previous_hospital_hospital_id) {
    $bb_slot_post = [];
  ...
  function bb_slot_update($hospital_id,$hospital_id,$slot_id) {
    $bb_slot_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $bb_slot_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function bb_slot_get_records($hospital_id,$hospital_id,$slot_id) {
    ...
    bb_slot.date AS bb_slot_date, bb_slot.from_time AS bb_slot_from_time,
    bb_slot.hospital_id AS bb_slot_hospital_id, bb_slot.no_appointments AS bb_slot_no_appointments,
    bb_slot.slot_id AS bb_slot_slot_id, bb_slot.to_time AS bb_slot_to_time')->from('bb_slot');
