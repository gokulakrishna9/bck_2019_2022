<?php class Antenatal_visit_model extends CI_Model {
  function antenatal_visit_create($mlc_visit_id,$patient_visit_visit_id) {
  ...
  function antenatal_visit_update($visit_id,$visit_id,$antenatal_visit_id) {
    $antenatal_visit_post['mlc.visit_id'] = $this->session->mlc_visit_id;
    $antenatal_visit_post['patient_visit.visit_id'] = $this->session->patient_visit_visit_id;
  ...
  function antenatal_visit_get_records($visit_id,$visit_id,$antenatal_visit_id) {
    ...
    antenatal_visit.advice AS antenatal_visit_advice, antenatal_visit.antenatal_visit_id AS antenatal_visit_antenatal_visit_id,
    antenatal_visit.fetal_heart_rate AS antenatal_visit_fetal_heart_rate, antenatal_visit.fundal_height AS antenatal_visit_fundal_height,
    antenatal_visit.liquor AS antenatal_visit_liquor, antenatal_visit.presentation AS antenatal_visit_presentation,
    antenatal_visit.scan_finding AS antenatal_visit_scan_finding, antenatal_visit.visit_id AS antenatal_visit_visit_id')->from('antenatal_visit');
