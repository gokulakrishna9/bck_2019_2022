<?php class Area_activity_model extends CI_Model {
  function area_activity_create($area_types_area_type_id) {
    $area_activity_post = [];
  ...
  function area_activity_update($area_type_id,$area_activity_id) {
    $area_activity_post['area_types.area_type_id'] = $this->session->area_types_area_type_id;
  ...
  function area_activity_get_records($area_type_id,$area_activity_id) {
    ...
    $this->db->select('area_types.area_type_id AS area_activity_area_type_id, area_activity.activity_name AS area_activity_activity_name,
    area_activity.area_activity_id AS area_activity_area_activity_id, area_activity.area_type_id AS area_activity_area_type_id,
    area_activity.frequency AS area_activity_frequency, area_activity.frequency_type AS area_activity_frequency_type,
    area_activity.weightage AS area_activity_weightage')->from('area_activity');
