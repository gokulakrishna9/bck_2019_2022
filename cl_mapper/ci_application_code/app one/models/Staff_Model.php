<?php class Staff_model extends CI_Model {
  function staff_create($area_area_id,$department_department_id,$hospital_hospital_id,$staff_previous_hospital_hospital_id,$qualification_qualification_id,$staff_applicant_qualification_master_qualification_id,$staff_category_staff_category_id,$staff_role_staff_role_id,$unit_unit_id) {
    $staff_post = [];
  ...
  function staff_update($area_id,$department_id,$hospital_id,$hospital_id,$qualification_id,$qualification_id,$staff_category_id,$staff_role_id,$unit_id,$staff_id) {
    $staff_post['area.area_id'] = $this->session->area_area_id;
    $staff_post['department.department_id'] = $this->session->department_department_id;
    $staff_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $staff_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function staff_get_records($area_id,$department_id,$hospital_id,$hospital_id,$qualification_id,$qualification_id,$staff_category_id,$staff_role_id,$unit_id,$staff_id) {
    ...
    $this->db->select('area.area_id AS staff_area_id, department.department_id AS staff_department_id,
    hospital.hospital_id AS staff_hospital_id, staff_previous_hospital.hospital_id AS staff_hospital_id,
    qualification.qualification_id AS staff_qualification_id, staff_applicant_qualification_master.qualification_id AS staff_qualification_id,
    staff_category.staff_category_id AS staff_staff_category_id, staff_role.staff_role_id AS staff_staff_role_id,
    unit.unit_id AS staff_unit_id, staff.account_name AS staff_account_name,
    staff.account_number AS staff_account_number, staff.area_id AS staff_area_id,
    staff.area_of_responsibility AS staff_area_of_responsibility, staff.bank AS staff_bank,
    staff.bank_branch AS staff_bank_branch, staff.date_of_birth AS staff_date_of_birth,
    staff.department_id AS staff_department_id, staff.designation AS staff_designation,
    staff.doctor_flag AS staff_doctor_flag, staff.doctor_reg_no AS staff_doctor_reg_no,
    staff.email AS staff_email, staff.first_name AS staff_first_name,
    staff.gender AS staff_gender, staff.hospital_id AS staff_hospital_id,
    staff.ifsc_code AS staff_ifsc_code, staff.ima_registration_number AS staff_ima_registration_number,
    staff.image AS staff_image, staff.last_name AS staff_last_name,
    staff.mci_flag AS staff_mci_flag, staff.name AS staff_name,
    staff.personal_note AS staff_personal_note, staff.phone AS staff_phone,
    staff.qualification_id AS staff_qualification_id, staff.research AS staff_research,
    staff.research_area AS staff_research_area, staff.specialisation AS staff_specialisation,
    staff.staff_category AS staff_staff_category, staff.staff_category_id AS staff_staff_category_id,
    staff.staff_flag AS staff_staff_flag, staff.staff_id AS staff_staff_id,
    staff.staff_role AS staff_staff_role, staff.staff_role_id AS staff_staff_role_id,
    staff.staff_status AS staff_staff_status, staff.staff_type AS staff_staff_type,
    staff.status AS staff_status, staff.status_date AS staff_status_date,
    staff.unit_id AS staff_unit_id')->from('staff');
