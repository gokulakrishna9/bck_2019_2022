<?php class Age_group_model extends CI_Model {
  ...
  function age_group_update($age_group_id) {
  ...
  function age_group_get_records($age_group_id) {
    ...
    $this->db->select('age_group.age_group_id AS age_group_age_group_id, age_group.from_day AS age_group_from_day,
    age_group.from_month AS age_group_from_month, age_group.from_year AS age_group_from_year,
    age_group.to_day AS age_group_to_day, age_group.to_month AS age_group_to_month,
    age_group.to_year AS age_group_to_year')->from('age_group');
