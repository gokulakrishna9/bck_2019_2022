<?php class Contact_person_model extends CI_Model {
  function contact_person_create($vendor_vendor_id) {
    $contact_person_post = [];
  ...
  function contact_person_update($vendor_id,$contact_person_id) {
    $contact_person_post['vendor.vendor_id'] = $this->session->vendor_vendor_id;
  ...
  function contact_person_get_records($vendor_id,$contact_person_id) {
    ...
    $this->db->select('vendor.vendor_id AS contact_person_vendor_id, contact_person.contact_person_contact AS contact_person_contact_person_contact,
    contact_person.contact_person_email AS contact_person_contact_person_email, contact_person.contact_person_first_name AS contact_person_contact_person_first_name,
    contact_person.contact_person_id AS contact_person_contact_person_id, contact_person.contact_person_last_name AS contact_person_contact_person_last_name,
    contact_person.designation AS contact_person_designation, contact_person.gender AS contact_person_gender,
    contact_person.vendor_id AS contact_person_vendor_id')->from('contact_person');
