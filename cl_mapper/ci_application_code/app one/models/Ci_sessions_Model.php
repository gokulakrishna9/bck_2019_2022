<?php class Ci_sessions_model extends CI_Model {
  ...
  function ci_sessions_update($session_id) {
  ...
  function ci_sessions_get_records($session_id) {
    ...
    $this->db->select('ci_sessions.ip_address AS ci_sessions_ip_address, ci_sessions.last_activity AS ci_sessions_last_activity,
    ci_sessions.session_id AS ci_sessions_session_id, ci_sessions.user_agent AS ci_sessions_user_agent,
