<?php class Icd_code_model extends CI_Model {
  ...
  function icd_code_update($icd_code) {
  ...
  function icd_code_get_records($icd_code) {
    ...
    $this->db->select('icd_code.block_id AS icd_code_block_id, icd_code.code_title AS icd_code_code_title,
    icd_code.icd_10 AS icd_code_icd_10, icd_code.icd_10_ext AS icd_code_icd_10_ext,
    icd_code.icd_code AS icd_code_icd_code')->from('icd_code');
