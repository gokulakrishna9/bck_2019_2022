<?php class Facility_activity_model extends CI_Model {
  function facility_activity_create($area_activity_area_activity_id,$facility_area_facility_area_id) {
  ...
  function facility_activity_update($area_activity_id,$facility_area_id,$activity_id) {
    $facility_activity_post['area_activity.area_activity_id'] = $this->session->area_activity_area_activity_id;
    $facility_activity_post['facility_area.facility_area_id'] = $this->session->facility_area_facility_area_id;
  ...
  function facility_activity_get_records($area_activity_id,$facility_area_id,$activity_id) {
    ...
    $this->db->select('area_activity.area_activity_id AS facility_activity_area_activity_id, facility_area.facility_area_id AS facility_activity_facility_area_id,
    facility_activity.activity_id AS facility_activity_activity_id, facility_activity.area_activity_id AS facility_activity_area_activity_id,
    facility_activity.facility_area_id AS facility_activity_facility_area_id')->from('facility_activity');
