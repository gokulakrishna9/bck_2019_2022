<?php class Test_group_link_model extends CI_Model {
  function test_group_link_create($test_group_group_id,$test_master_test_master_id) {
  ...
  function test_group_link_update($group_id,$test_master_id,$link_id) {
    $test_group_link_post['test_group.group_id'] = $this->session->test_group_group_id;
    $test_group_link_post['test_master.test_master_id'] = $this->session->test_master_test_master_id;
  ...
  function test_group_link_get_records($group_id,$test_master_id,$link_id) {
    ...
    test_group_link.group_id AS test_group_link_group_id, test_group_link.link_id AS test_group_link_link_id,
