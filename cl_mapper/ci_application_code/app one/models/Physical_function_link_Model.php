<?php class Physical_function_link_model extends CI_Model {
  ...
  function physical_function_link_update($link_id) {
  ...
  function physical_function_link_get_records($link_id) {
    ...
    $this->db->select('physical_function_link.function_id AS physical_function_link_function_id, physical_function_link.link_id AS physical_function_link_link_id,
