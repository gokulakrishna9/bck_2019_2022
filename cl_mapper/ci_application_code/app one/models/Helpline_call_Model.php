<?php class Helpline_call_model extends CI_Model {
  function helpline_call_create($helpline_call_category_call_category_id,$helpline_call_group_call_group_id,$helpline_caller_type_caller_type_id,$hospital_hospital_id,$staff_previous_hospital_hospital_id,$helpline_resolution_status_resolution_status_id,$mlc_visit_id,$patient_visit_visit_id) {
    $helpline_call_post = [];
  ...
  function helpline_call_update($call_category_id,$call_group_id,$caller_type_id,$hospital_id,$hospital_id,$resolution_status_id,$visit_id,$visit_id,$call_id) {
    $helpline_call_post['helpline_call_category.call_category_id'] = $this->session->helpline_call_category_call_category_id;
    $helpline_call_post['helpline_call_group.call_group_id'] = $this->session->helpline_call_group_call_group_id;
    $helpline_call_post['helpline_caller_type.caller_type_id'] = $this->session->helpline_caller_type_caller_type_id;
    $helpline_call_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
  ...
  function helpline_call_get_records($call_category_id,$call_group_id,$caller_type_id,$hospital_id,$hospital_id,$resolution_status_id,$visit_id,$visit_id,$call_id) {
    ...
    $this->db->select('helpline_call_category.call_category_id AS helpline_call_call_category_id, helpline_call_group.call_group_id AS helpline_call_call_group_id,
    helpline_caller_type.caller_type_id AS helpline_call_caller_type_id, hospital.hospital_id AS helpline_call_hospital_id,
    staff_previous_hospital.hospital_id AS helpline_call_hospital_id, helpline_resolution_status.resolution_status_id AS helpline_call_resolution_status_id,
    mlc.visit_id AS helpline_call_visit_id, patient_visit.visit_id AS helpline_call_visit_id,
    helpline_call.call_category_id AS helpline_call_call_category_id, helpline_call.call_group_id AS helpline_call_call_group_id,
    helpline_call.call_id AS helpline_call_call_id, helpline_call.call_type AS helpline_call_call_type,
    helpline_call.caller_type_id AS helpline_call_caller_type_id, helpline_call.callsid AS helpline_call_callsid,
    helpline_call.create_date_time AS helpline_call_create_date_time, helpline_call.current_server_time AS helpline_call_current_server_time,
    helpline_call.dial_call_duration AS helpline_call_dial_call_duration, helpline_call.dial_whom_number AS helpline_call_dial_whom_number,
    helpline_call.direction AS helpline_call_direction, helpline_call.end_time AS helpline_call_end_time,
    helpline_call.from_number AS helpline_call_from_number, helpline_call.hospital_id AS helpline_call_hospital_id,
    helpline_call.ip_op AS helpline_call_ip_op, helpline_call.note AS helpline_call_note,
    helpline_call.recording_url AS helpline_call_recording_url, helpline_call.resolution_date_time AS helpline_call_resolution_date_time,
    helpline_call.resolution_status_id AS helpline_call_resolution_status_id, helpline_call.start_time AS helpline_call_start_time,
    helpline_call.to_number AS helpline_call_to_number, helpline_call.update_date_time AS helpline_call_update_date_time,
    helpline_call.updated AS helpline_call_updated, helpline_call.visit_id AS helpline_call_visit_id')->from('helpline_call');
