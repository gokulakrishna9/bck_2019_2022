<?php class Patient_procedure_model extends CI_Model {
  function patient_procedure_create($procedure_procedure_id,$procedure_plan_procedure_plan_id) {
  ...
  function patient_procedure_update($procedure_id,$procedure_plan_id,$patient_procedure_id) {
    $patient_procedure_post['procedure.procedure_id'] = $this->session->procedure_procedure_id;
    $patient_procedure_post['procedure_plan.procedure_plan_id'] = $this->session->procedure_plan_procedure_plan_id;
  ...
  function patient_procedure_get_records($procedure_id,$procedure_plan_id,$patient_procedure_id) {
    ...
    $this->db->select('procedure.procedure_id AS patient_procedure_procedure_id, procedure_plan.procedure_plan_id AS patient_procedure_procedure_plan_id,
    patient_procedure.patient_procedure_id AS patient_procedure_patient_procedure_id, patient_procedure.post_procedure AS patient_procedure_post_procedure,
    ...
    patient_procedure.procedure_findings AS patient_procedure_procedure_findings, patient_procedure.procedure_id AS patient_procedure_procedure_id,
    patient_procedure.procedure_note AS patient_procedure_procedure_note, patient_procedure.procedure_plan_id AS patient_procedure_procedure_plan_id,
    patient_procedure.visit_id AS patient_procedure_visit_id')->from('patient_procedure');
