<?php class Procedure_staff_model extends CI_Model {
  function procedure_staff_create($patient_procedure_patient_procedure_id,$staff_staff_id) {
  ...
  function procedure_staff_update($patient_procedure_id,$staff_id,$procedure_staff_id) {
    $procedure_staff_post['patient_procedure.patient_procedure_id'] = $this->session->patient_procedure_patient_procedure_id;
    $procedure_staff_post['staff.staff_id'] = $this->session->staff_staff_id;
  ...
  function procedure_staff_get_records($patient_procedure_id,$staff_id,$procedure_staff_id) {
    ...
    procedure_staff.patient_procedure_id AS procedure_staff_patient_procedure_id, procedure_staff.procedure_staff_id AS procedure_staff_procedure_staff_id,
