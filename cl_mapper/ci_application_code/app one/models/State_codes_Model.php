<?php class State_codes_model extends CI_Model {
  ...
  function state_codes_update($state_id) {
  ...
  function state_codes_get_records($state_id) {
    ...
    $this->db->select('state_codes.country_code AS state_codes_country_code, state_codes.state_code AS state_codes_state_code,
    state_codes.state_id AS state_codes_state_id, state_codes.state_name AS state_codes_state_name,
