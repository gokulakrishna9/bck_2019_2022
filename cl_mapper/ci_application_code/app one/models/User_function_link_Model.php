<?php class User_function_link_model extends CI_Model {
  function user_function_link_create($bb_user_user_id,$user_user_id) {
  ...
  function user_function_link_update($user_id,$user_id,$link_id) {
    $user_function_link_post['bb_user.user_id'] = $this->session->bb_user_user_id;
    $user_function_link_post['user.user_id'] = $this->session->user_user_id;
  ...
  function user_function_link_get_records($user_id,$user_id,$link_id) {
    ...
    user_function_link.active AS user_function_link_active, user_function_link.add AS user_function_link_add,
    user_function_link.edit AS user_function_link_edit, user_function_link.function_id AS user_function_link_function_id,
    user_function_link.link_id AS user_function_link_link_id, user_function_link.user_id AS user_function_link_user_id,
    user_function_link.view AS user_function_link_view')->from('user_function_link');
