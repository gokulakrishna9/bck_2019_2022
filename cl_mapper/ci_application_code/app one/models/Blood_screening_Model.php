<?php class Blood_screening_model extends CI_Model {
  function blood_screening_create($bb_donation_donation_id,$hospital_hospital_id,$staff_previous_hospital_hospital_id) {
  ...
  function blood_screening_update($donation_id,$hospital_id,$hospital_id,$screening_id) {
    $blood_screening_post['bb_donation.donation_id'] = $this->session->bb_donation_donation_id;
    $blood_screening_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $blood_screening_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function blood_screening_get_records($donation_id,$hospital_id,$hospital_id,$screening_id) {
    ...
    staff_previous_hospital.hospital_id AS blood_screening_hospital_id, blood_screening.donation_id AS blood_screening_donation_id,
    blood_screening.hospital_id AS blood_screening_hospital_id, blood_screening.screened_by AS blood_screening_screened_by,
    blood_screening.screening_datetime AS blood_screening_screening_datetime, blood_screening.screening_id AS blood_screening_screening_id,
    blood_screening.screening_result AS blood_screening_screening_result, blood_screening.test_hbsag AS blood_screening_test_hbsag,
    blood_screening.test_hcv AS blood_screening_test_hcv, blood_screening.test_hiv AS blood_screening_test_hiv,
    blood_screening.test_irregular_ab AS blood_screening_test_irregular_ab, blood_screening.test_mp AS blood_screening_test_mp,
    blood_screening.test_vdrl AS blood_screening_test_vdrl')->from('blood_screening');
