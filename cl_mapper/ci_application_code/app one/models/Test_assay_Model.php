<?php class Test_assay_model extends CI_Model {
  function test_assay_create($hospital_hospital_id,$staff_previous_hospital_hospital_id) {
    $test_assay_post = [];
  ...
  function test_assay_update($hospital_id,$hospital_id,$assay_id) {
    $test_assay_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $test_assay_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function test_assay_get_records($hospital_id,$hospital_id,$assay_id) {
    ...
    test_assay.assay AS test_assay_assay, test_assay.assay_id AS test_assay_assay_id,
    test_assay.hospital_id AS test_assay_hospital_id, test_assay.temp_assay_id AS test_assay_temp_assay_id')->from('test_assay');
