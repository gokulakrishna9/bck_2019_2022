<?php class Form_model extends CI_Model {
  function form_create($hospital_hospital_id,$staff_previous_hospital_hospital_id,$print_layout_print_layout_id) {
    $form_post = [];
  ...
  function form_update($hospital_id,$hospital_id,$print_layout_id,$form_id) {
    $form_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $form_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
    $form_post['print_layout.print_layout_id'] = $this->session->print_layout_print_layout_id;
  ...
  function form_get_records($hospital_id,$hospital_id,$print_layout_id,$form_id) {
    ...
    $this->db->select('hospital.hospital_id AS form_hospital_id, staff_previous_hospital.hospital_id AS form_hospital_id,
    print_layout.print_layout_id AS form_print_layout_id, form.form_id AS form_form_id,
    form.form_name AS form_form_name, form.form_type AS form_form_type,
    form.hospital_id AS form_hospital_id, form.num_columns AS form_num_columns,
    form.print_layout_id AS form_print_layout_id')->from('form');
