<?php class Bb_app_slot_link_model extends CI_Model {
  function bb_app_slot_link_create($bb_appointment_appointment_id,$hospital_hospital_id,$staff_previous_hospital_hospital_id,$bb_slot_slot_id) {
  ...
  function bb_app_slot_link_update($appointment_id,$hospital_id,$hospital_id,$slot_id,$link_id) {
    $bb_app_slot_link_post['bb_appointment.appointment_id'] = $this->session->bb_appointment_appointment_id;
    $bb_app_slot_link_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $bb_app_slot_link_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
    $bb_app_slot_link_post['bb_slot.slot_id'] = $this->session->bb_slot_slot_id;
  ...
  function bb_app_slot_link_get_records($appointment_id,$hospital_id,$hospital_id,$slot_id,$link_id) {
    ...
    $this->db->select('bb_appointment.appointment_id AS bb_app_slot_link_appointment_id, hospital.hospital_id AS bb_app_slot_link_hospital_id,
    staff_previous_hospital.hospital_id AS bb_app_slot_link_hospital_id, bb_slot.slot_id AS bb_app_slot_link_slot_id,
    bb_app_slot_link.appointment_id AS bb_app_slot_link_appointment_id, bb_app_slot_link.datetime AS bb_app_slot_link_datetime,
    bb_app_slot_link.hospital_id AS bb_app_slot_link_hospital_id, bb_app_slot_link.link_id AS bb_app_slot_link_link_id,
    bb_app_slot_link.slot_id AS bb_app_slot_link_slot_id')->from('bb_app_slot_link');
