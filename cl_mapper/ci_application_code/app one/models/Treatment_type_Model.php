<?php class Treatment_type_model extends CI_Model {
  ...
  function treatment_type_update($treatment_type_id) {
  ...
  function treatment_type_get_records($treatment_type_id) {
    ...
    $this->db->select('treatment_type.treatment_type AS treatment_type_treatment_type, treatment_type.treatment_type_id AS treatment_type_treatment_type_id')->from('treatment_type');
