<?php class Swap_request_sent_model extends CI_Model {
  function swap_request_sent_create($swap_request_swap_id) {
  ...
  function swap_request_sent_update($swap_id,$swap_request_sent_id) {
    $swap_request_sent_post['swap_request.swap_id'] = $this->session->swap_request_swap_id;
  ...
  function swap_request_sent_get_records($swap_id,$swap_request_sent_id) {
    ...
    $this->db->select('swap_request.swap_id AS swap_request_sent_swap_id, swap_request_sent.staff_id_sent_to AS swap_request_sent_staff_id_sent_to,
    swap_request_sent.swap_id AS swap_request_sent_swap_id, swap_request_sent.swap_request_sent_id AS swap_request_sent_swap_request_sent_id')->from('swap_request_sent');
