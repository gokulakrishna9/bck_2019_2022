<?php class Staff_recruitment_drive_model extends CI_Model {
  ...
  function staff_recruitment_drive_update($drive_id) {
  ...
  function staff_recruitment_drive_get_records($drive_id) {
    ...
    $this->db->select('staff_recruitment_drive.drive_id AS staff_recruitment_drive_drive_id, staff_recruitment_drive.name AS staff_recruitment_drive_name,
    staff_recruitment_drive.place AS staff_recruitment_drive_place, staff_recruitment_drive.start_date AS staff_recruitment_drive_start_date')->from('staff_recruitment_drive');
