<?php class Helpline_receiver_model extends CI_Model {
  ...
  function helpline_receiver_update($receiver_id) {
  ...
  function helpline_receiver_get_records($receiver_id) {
    ...
    $this->db->select('helpline_receiver.email AS helpline_receiver_email, helpline_receiver.full_name AS helpline_receiver_full_name,
    helpline_receiver.phone AS helpline_receiver_phone, helpline_receiver.receiver_id AS helpline_receiver_receiver_id,
    helpline_receiver.short_name AS helpline_receiver_short_name')->from('helpline_receiver');
