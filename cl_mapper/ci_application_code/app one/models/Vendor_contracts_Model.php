<?php class Vendor_contracts_model extends CI_Model {
  function vendor_contracts_create($facility_facility_id,$vendor_vendor_id) {
  ...
  function vendor_contracts_update($facility_id,$vendor_id,$contract_id) {
    $vendor_contracts_post['facility.facility_id'] = $this->session->facility_facility_id;
    $vendor_contracts_post['vendor.vendor_id'] = $this->session->vendor_vendor_id;
  ...
  function vendor_contracts_get_records($facility_id,$vendor_id,$contract_id) {
    ...
    $this->db->select('facility.facility_id AS vendor_contracts_facility_id, vendor.vendor_id AS vendor_contracts_vendor_id,
    vendor_contracts.contract_id AS vendor_contracts_contract_id, vendor_contracts.facility_id AS vendor_contracts_facility_id,
    vendor_contracts.from_date AS vendor_contracts_from_date, vendor_contracts.status AS vendor_contracts_status,
    vendor_contracts.to_date AS vendor_contracts_to_date, vendor_contracts.vendor_id AS vendor_contracts_vendor_id')->from('vendor_contracts');
