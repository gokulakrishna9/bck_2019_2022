<?php class Area_types_model extends CI_Model {
  ...
  function area_types_update($area_type_id) {
  ...
  function area_types_get_records($area_type_id) {
    ...
    $this->db->select('area_types.area_type AS area_types_area_type, area_types.area_type_id AS area_types_area_type_id')->from('area_types');
