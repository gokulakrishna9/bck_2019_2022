<?php class Procedure_model extends CI_Model {
  function procedure_create($procedure_type_procedure_type_id) {
    $procedure_post = [];
  ...
  function procedure_update($procedure_type_id,$procedure_id) {
    $procedure_post['procedure_type.procedure_type_id'] = $this->session->procedure_type_procedure_type_id;
  ...
  function procedure_get_records($procedure_type_id,$procedure_id) {
