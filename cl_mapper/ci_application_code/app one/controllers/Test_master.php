<?php 
 ...
 class Test_master extends CI_CONTROLLER {
  ...
  public function test_master_create() {
    $this->load->model('test_assay_model');
    ...
    $this->data['test_master_create'] = $this->test_master_model->test_master_create();
    $this->data['test_master'] = $this->test_master_model->test_master_get_records();
    $this->load->view('test_master/default_grid', $this->data);
  }
  public function test_master_update() {
    ...
    $this->data['test_area'] = $this->test_area_model->test_area_get_records();
    $this->data['test_method'] = $this->test_method_model->test_method_get_records();
    $this->data['test_master_update'] = $this->test_master_model->test_master_update();
    $this->data['test_master'] = $this->test_master_model->test_master_get_records();
    $this->load->view('test_master/default_grid', $this->data);
  }
  public function test_master_delete() {
    ...
    $this->data['test_area'] = $this->test_area_model->test_area_get_records();
    $this->data['test_method'] = $this->test_method_model->test_method_get_records();
    $this->data['test_master_delete'] = $this->test_master_model->test_master_delete();
    $this->data['test_master'] = $this->test_master_model->test_master_get_records();
    $this->load->view('test_master/default_grid', $this->data);
  }
  public function test_master_select() {
    $this->load->model('test_assay_model');
    $this->load->model('hospital_model');
    $this->load->model('staff_previous_hospital_model');
    $this->load->model('test_area_model');
