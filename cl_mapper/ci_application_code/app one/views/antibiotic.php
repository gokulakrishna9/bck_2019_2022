...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      ...
      <input type="text" class="form-control" name="antibiotic" value="<?php echo $input_data->antibiotic; ?>" id="antibiotic">
    </div>
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="temp_antibiotic_id">Temp Antibiotic Id</label>
      <input type="number" class="form-control" name="temp_antibiotic_id" value="<?php echo $input_data->temp_antibiotic_id; ?>" id="temp_antibiotic_id">
    </div>
    <div class="form-group col-md-6" id="">
      
      <input type="hidden" class="form-control" name="antibiotic_id" value="<?php echo $input_data->antibiotic_id; ?>" id="antibiotic_id">
    </div>
  </div>
  <div class="form-row" id="">
    <div class="form-group col-md-6" id="">
    ...
    <div class="form-group col-md-6" id="">
      ...
      <div class="row">
        ...
        <th scope="col">Temp Antibiotic Id</th>
        </tr></thead>
        <tbody>
        <?php if(sizeof($antibiotic) > 0){
            forEach($antibiotic as $index => $record) { ?>
                <tr><td><?php echo $index; ?></td>
                    <td><a class="btn btn-outline-warning btn-sm" href='#'>Update</a></td>
                    <td><?php echo $record->antibiotic; ?></td>
                    <td><?php echo $record->hospital_id; ?></td>
                    <td><?php echo $record->temp_antibiotic_id; ?></td>
                </tr>
            <?php }} ?>
        </tbody>
  </table>
