...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="group_id">Binary Negative</label>
      <?php foreach($test_group as $record){ ?>
      <select class="form-control" name="group_id" id="group_id">
      <option value="<?php echo $record->group_id; ?>" <?php if($input_data->group_id == $record->group_id) echo 'selected'; ?>><?php echo $record->binary_negative; ?></option>
      <?php } ?>
      </select>
    </div>
  </div>
    <div class="form-group col-md-6" id="">
      ...
      <div class="row">
        ...
        <tbody>
        <?php if(sizeof($test_group_link) > 0){
            forEach($test_group_link as $index => $record) { ?>
