...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="counter_name">Counter Name</label>
      <input type="text" class="form-control" name="counter_name" value="<?php echo $input_data->counter_name; ?>" id="counter_name">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="count">Count</label>
      <input type="number" class="form-control" name="count" value="<?php echo $input_data->count; ?>" id="count">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
      
      <input type="hidden" class="form-control" name="counter_id" value="<?php echo $input_data->counter_id; ?>" id="counter_id">
    </div>
  </div>
  <div class="form-row" id="">
    <div class="form-group col-md-6" id="">
    ...
    <div class="form-group col-md-6" id="">
      ...
      <div class="row">
        ...
        <?php if(sizeof($counter) > 0){
            forEach($counter as $index => $record) { ?>
                <tr><td><?php echo $index; ?></td>
                    <td><a class="btn btn-outline-warning btn-sm" href='#'>Update</a></td>
                    <td><?php echo $record->count; ?></td>
                    <td><?php echo $record->counter_name; ?></td>
