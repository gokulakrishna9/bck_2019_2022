...
<html lang="en">
  ...
  <div class="form-row" id="">
    <div class="form-group col-md-6" id="">
      ...
      <input type="hidden" class="form-control" name="age_group_id" value="<?php echo $input_data->age_group_id; ?>" id="age_group_id">
    </div>
        </div>
      </div>
      <div class="row">
        ...
        <tbody>
        <?php if(sizeof($age_group) > 0){
            forEach($age_group as $index => $record) { ?>
