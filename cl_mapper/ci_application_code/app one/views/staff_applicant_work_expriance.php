...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="experiance_years">Experiance Years</label>
      <input type="text" class="form-control" name="experiance_years" value="<?php echo $input_data->experiance_years; ?>" id="experiance_years">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="role_id">Role Id</label>
      <input type="number" class="form-control" name="role_id" value="<?php echo $input_data->role_id; ?>" id="role_id">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
  ...
  <div class="form-row" id="">
    ...
    <div class="form-group col-md-6" id="">
      ...
      <input type="hidden" class="form-control" name="experiance_id" value="<?php echo $input_data->experiance_id; ?>" id="experiance_id">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="applicant_id">Address</label>
      <?php foreach($staff_applicant as $record){ ?>
      <select class="form-control" name="applicant_id" id="applicant_id">
      <option value="<?php echo $record->applicant_id; ?>" <?php if($input_data->applicant_id == $record->applicant_id) echo 'selected'; ?>><?php echo $record->address; ?></option>
      <?php } ?>
      </select>
    </div>
  </div>
  <div class="form-row" id="">
    ...
    <div class="form-group col-md-6" id="">
      ...
      <div class="row">
        ...
        <th scope="col">Experiance Years</th>
        ...
        <tbody>
        <?php if(sizeof($staff_applicant_work_expriance) > 0){
            forEach($staff_applicant_work_expriance as $index => $record) { ?>
                <tr><td><?php echo $index; ?></td>
                    <td><a class="btn btn-outline-warning btn-sm" href='#'>Update</a></td>
                    <td><?php echo $record->applicant_id; ?></td>
                    <td><?php echo $record->experiance_years; ?></td>
