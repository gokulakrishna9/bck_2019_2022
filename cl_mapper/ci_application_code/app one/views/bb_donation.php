...
<html lang="en">
  ...
  <div class="form-row" id="">
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="replacement_patient_id">Blood Group</label>
      ...
      <option value="<?php echo $record->replacement_patient_id; ?>" <?php if($input_data->replacement_patient_id == $record->replacement_patient_id) echo 'selected'; ?>><?php echo $record->blood_group; ?></option>
      <?php } ?>
      </select>
    </div>
  </div>
