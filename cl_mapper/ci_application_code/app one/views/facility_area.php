...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      ...
      <input type="hidden" class="form-control" name="facility_area_id" value="<?php echo $input_data->facility_area_id; ?>" id="facility_area_id">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
  ...
  <div class="form-row" id="">
    ...
    <div class="form-group col-md-6" id="">
      ...
      <div class="row">
        ...
        <tbody>
        <?php if(sizeof($facility_area) > 0){
            forEach($facility_area as $index => $record) { ?>
