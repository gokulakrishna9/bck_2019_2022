...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      ...
      <input type="hidden" class="form-control" name="arrival_id" value="<?php echo $input_data->arrival_id; ?>" id="arrival_id">
    </div>
  </div>
        </div>
      </div>
      <div class="row">
        ...
        <tbody>
        <?php if(sizeof($patient_arrival_mode) > 0){
            forEach($patient_arrival_mode as $index => $record) { ?>
