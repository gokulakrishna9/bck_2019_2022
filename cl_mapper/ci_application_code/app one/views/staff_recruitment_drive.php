...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      ...
      <input type="date" class="form-control" name="start_date" value="<?php echo $input_data->start_date; ?>" id="start_date">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
      
      <input type="hidden" class="form-control" name="drive_id" value="<?php echo $input_data->drive_id; ?>" id="drive_id">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
  ...
  <div class="form-row" id="">
    <div class="form-group col-md-6" id="">
      ...
      <div class="row">
        ...
        <tbody>
        <?php if(sizeof($staff_recruitment_drive) > 0){
            forEach($staff_recruitment_drive as $index => $record) { ?>
