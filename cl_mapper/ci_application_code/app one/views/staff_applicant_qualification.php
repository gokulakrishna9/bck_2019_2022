...
<html lang="en">
  ...
  <div class="form-row" id="">
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="college_id">Address</label>
      <?php foreach($staff_applicant_college as $record){ ?>
      <select class="form-control" name="college_id" id="college_id">
      <option value="<?php echo $record->college_id; ?>" <?php if($input_data->college_id == $record->college_id) echo 'selected'; ?>><?php echo $record->address; ?></option>
      <?php } ?>
      </select>
    </div>
  </div>
