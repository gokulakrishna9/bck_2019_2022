...
<html lang="en">
  ...
  <div class="form-row" id="">
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="request_id">Blood Group</label>
      <?php foreach($blood_request as $record){ ?>
      <select class="form-control" name="request_id" id="request_id">
      <option value="<?php echo $record->request_id; ?>" <?php if($input_data->request_id == $record->request_id) echo 'selected'; ?>><?php echo $record->blood_group; ?></option>
      <?php } ?>
      </select>
    </div>
  </div>
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="request_id">Call Information</label>
      <?php foreach($service_record as $record){ ?>
      <select class="form-control" name="request_id" id="request_id">
      <option value="<?php echo $record->request_id; ?>" <?php if($input_data->request_id == $record->request_id) echo 'selected'; ?>><?php echo $record->call_information; ?></option>
      <?php } ?>
      </select>
    </div>
  </div>
