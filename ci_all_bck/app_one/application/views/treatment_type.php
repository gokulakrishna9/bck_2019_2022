...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      ...
      <input type="hidden" class="form-control" name="treatment_type_id" value="<?php echo $input_data->treatment_type_id; ?>" id="treatment_type_id">
    </div>
  </div>
        </div>
      </div>
      <div class="row">
        ...
        <tbody>
        <?php if(sizeof($treatment_type) > 0){
            forEach($treatment_type as $index => $record) { ?>
