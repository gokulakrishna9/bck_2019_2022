...
<html lang="en">
  ...
  <div class="form-row" id="">
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="test_method_id">Test Method</label>
      <?php foreach($test_method as $record){ ?>
      <select class="form-control" name="test_method_id" id="test_method_id">
      <option value="<?php echo $record->test_method_id; ?>" <?php if($input_data->test_method_id == $record->test_method_id) echo 'selected'; ?>><?php echo $record->test_method; ?></option>
      <?php } ?>
      </select>
    </div>
  </div>
