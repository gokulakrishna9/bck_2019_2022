...
<html lang="en">
  ...
  <div class="form-row" id="">
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="contact_person_id">Contact Person First Name</label>
      <?php foreach($contact_person as $record){ ?>
      <select class="form-control" name="contact_person_id" id="contact_person_id">
      <option value="<?php echo $record->contact_person_id; ?>" <?php if($input_data->contact_person_id == $record->contact_person_id) echo 'selected'; ?>><?php echo $record->contact_person_first_name; ?></option>
      <?php } ?>
      </select>
    </div>
  </div>
