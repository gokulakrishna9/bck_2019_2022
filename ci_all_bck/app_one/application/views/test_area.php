...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="temp_test_area_id">Temp Test Area Id</label>
      <input type="number" class="form-control" name="temp_test_area_id" value="<?php echo $input_data->temp_test_area_id; ?>" id="temp_test_area_id">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
      
      <input type="hidden" class="form-control" name="test_area_id" value="<?php echo $input_data->test_area_id; ?>" id="test_area_id">
    </div>
  </div>
    <div class="form-group col-md-6" id="">
  ...
  <div class="form-row" id="">
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="test_area">Test Area</label>
      <textarea class="form-control" name="test_area" id="test_area" rows="3"><?php echo $input_data->test_area; ?></textarea>
    </div>
  </div>
        </div>
      </div>
      <div class="row">
        ...
        <th scope="col">Temp Test Area Id</th>
        </tr></thead>
        <tbody>
        <?php if(sizeof($test_area) > 0){
            forEach($test_area as $index => $record) { ?>
                <tr><td><?php echo $index; ?></td>
                    <td><a class="btn btn-outline-warning btn-sm" href='#'>Update</a></td>
                    <td><?php echo $record->test_area; ?></td>
                    <td><?php echo $record->department_id; ?></td>
                    <td><?php echo $record->hospital_id; ?></td>
                    <td><?php echo $record->temp_test_area_id; ?></td>
                </tr>
            <?php }} ?>
        </tbody>
  </table>
