...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="hospital_name">Hospital Name</label>
      <textarea class="form-control" name="hospital_name" id="hospital_name" rows="3"><?php echo $input_data->hospital_name; ?></textarea>
    </div>
  </div>
  <div class="form-row" id="">
    <div class="form-group col-md-6" id="">
      ...
      <div class="row">
        ...
        <tbody>
        <?php if(sizeof($staff_previous_hospital) > 0){
            forEach($staff_previous_hospital as $index => $record) { ?>
