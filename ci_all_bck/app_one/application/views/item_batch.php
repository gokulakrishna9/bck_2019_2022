...
<html lang="en">
  ...
  <div class="form-row" id="">
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="item_id">Item Name</label>
      <?php foreach($item as $record){ ?>
      <select class="form-control" name="item_id" id="item_id">
      <option value="<?php echo $record->item_id; ?>" <?php if($input_data->item_id == $record->item_id) echo 'selected'; ?>><?php echo $record->item_name; ?></option>
      <?php } ?>
      </select>
    </div>
  </div>
