...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group col-md-6" id="">
      ...
      <input type="hidden" class="form-control" name="camp_id" value="<?php echo $input_data->camp_id; ?>" id="camp_id">
    </div>
    <div class="form-group col-md-6" id="">
  ...
  <div class="form-row" id="">
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="camp_name">Camp Name</label>
      <textarea class="form-control" name="camp_name" id="camp_name" rows="3"><?php echo $input_data->camp_name; ?></textarea>
    </div>
    <div class="form-group col-md-6" id="">
      <label class="form-check-label" for="location">Location</label>
      <textarea class="form-control" name="location" id="location" rows="3"><?php echo $input_data->location; ?></textarea>
    </div>
        </div>
      </div>
      <div class="row">
        ...
        <tbody>
        <?php if(sizeof($blood_donation_camp) > 0){
            forEach($blood_donation_camp as $index => $record) { ?>
                <tr><td><?php echo $index; ?></td>
                    <td><a class="btn btn-outline-warning btn-sm" href='#'>Update</a></td>
                    <td><?php echo $record->camp_name; ?></td>
