<?php class Leave_model extends CI_Model {
  ...
  function leave_get_records() {
    ...
    $this->db->select('staff.staff_id AS leave_staff_id, leave_type.leave_type_id AS leave_leave_type_id,
    leave.leave_id AS leave_leave_id, leave.staff_id AS leave_staff_id,
    leave.leave_status AS leave_leave_status, leave.leave_submission_date AS leave_leave_submission_date,
    leave.leave_date AS leave_leave_date, leave.comment AS leave_comment,
    leave.leave_type_id AS leave_leave_type_id')->from('leave');
