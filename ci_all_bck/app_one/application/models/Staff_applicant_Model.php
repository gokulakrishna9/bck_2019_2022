<?php class Staff_applicant_model extends CI_Model {
  function staff_applicant_create() {
  ...
  function staff_applicant_update() {
    $staff_applicant_post['district.district_id'] = $this->session->district_district_id;
    $staff_applicant_post['staff_recruitment_drive.drive_id'] = $this->session->staff_recruitment_drive_drive_id;
    $staff_applicant_post['staff.staff_id'] = $this->session->staff_staff_id;
  ...
  function staff_applicant_get_records() {
    ...
    staff.staff_id AS staff_applicant_staff_id, staff_applicant.applicant_id AS staff_applicant_applicant_id,
    staff_applicant.first_name AS staff_applicant_first_name, staff_applicant.last_name AS staff_applicant_last_name,
    staff_applicant.gender AS staff_applicant_gender, staff_applicant.date_of_birth AS staff_applicant_date_of_birth,
    staff_applicant.fathers_name AS staff_applicant_fathers_name, staff_applicant.mothers_name AS staff_applicant_mothers_name,
    staff_applicant.husbands_name AS staff_applicant_husbands_name, staff_applicant.address AS staff_applicant_address,
    staff_applicant.place AS staff_applicant_place, staff_applicant.district_id AS staff_applicant_district_id,
    staff_applicant.phone AS staff_applicant_phone, staff_applicant.phone_alternate AS staff_applicant_phone_alternate,
    staff_applicant.email AS staff_applicant_email, staff_applicant.drive_id AS staff_applicant_drive_id,
