<?php class Bloodbank_edit_log_model extends CI_Model {
  function bloodbank_edit_log_create() {
  ...
  function bloodbank_edit_log_update() {
    $bloodbank_edit_log_post['staff.staff_id'] = $this->session->staff_staff_id;
  ...
  function bloodbank_edit_log_get_records() {
    ...
    bloodbank_edit_log.trail AS bloodbank_edit_log_trail, bloodbank_edit_log.staff_id AS bloodbank_edit_log_staff_id')->from('bloodbank_edit_log');
