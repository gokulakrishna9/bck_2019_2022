<?php class Publication_model extends CI_Model {
  ...
  function publication_get_records() {
    ...
    $this->db->select('staff.staff_id AS publication_staff_id, publication.publication_id AS publication_publication_id,
    publication.staff_id AS publication_staff_id, publication.title AS publication_title,
    publication.journal AS publication_journal, publication.edition AS publication_edition')->from('publication');
