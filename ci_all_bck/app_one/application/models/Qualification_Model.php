<?php class Qualification_model extends CI_Model {
  ...
  function qualification_get_records() {
    ...
    $this->db->select('staff.staff_id AS qualification_staff_id, qualification.qualification_id AS qualification_qualification_id,
    qualification.staff_id AS qualification_staff_id, qualification.degree AS qualification_degree,
    qualification.year_of_completion AS qualification_year_of_completion, qualification.university AS qualification_university')->from('qualification');
