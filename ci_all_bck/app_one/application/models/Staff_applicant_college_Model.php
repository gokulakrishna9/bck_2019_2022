<?php class Staff_applicant_college_model extends CI_Model {
  function staff_applicant_college_create() {
  ...
  function staff_applicant_college_update() {
    $staff_applicant_college_post['district.district_id'] = $this->session->district_district_id;
  ...
  function staff_applicant_college_get_records() {
    ...
    $this->db->select('district.district_id AS staff_applicant_college_district_id, staff_applicant_college.college_id AS staff_applicant_college_college_id,
    staff_applicant_college.college_name AS staff_applicant_college_college_name, staff_applicant_college.affiliated_to AS staff_applicant_college_affiliated_to,
    staff_applicant_college.address AS staff_applicant_college_address, staff_applicant_college.district_id AS staff_applicant_college_district_id,
    staff_applicant_college.email AS staff_applicant_college_email, staff_applicant_college.university_flag AS staff_applicant_college_university_flag,
    staff_applicant_college.public_institution_flag AS staff_applicant_college_public_institution_flag')->from('staff_applicant_college');
