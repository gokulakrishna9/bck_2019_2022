<?php class Vendor_model extends CI_Model {
  ...
  function vendor_get_records() {
    ...
    $this->db->select('vendor_type.vendor_type_id AS vendor_vendor_type_id, contact_person.contact_person_id AS vendor_contact_person_id,
    vendor.vendor_id AS vendor_vendor_id, vendor.vendor_type_id AS vendor_vendor_type_id,
    vendor.vendor_name AS vendor_vendor_name, vendor.vendor_address AS vendor_vendor_address,
    vendor.vendor_city AS vendor_vendor_city, vendor.vendor_state AS vendor_vendor_state,
    vendor.vendor_country AS vendor_vendor_country, vendor.account_no AS vendor_account_no,
    vendor.bank_name AS vendor_bank_name, vendor.branch AS vendor_branch,
    vendor.vendor_email AS vendor_vendor_email, vendor.vendor_phone AS vendor_vendor_phone,
    vendor.contact_person_id AS vendor_contact_person_id, vendor.vendor_pan AS vendor_vendor_pan')->from('vendor');
