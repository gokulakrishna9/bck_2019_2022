<?php class Test_result_suggestion_model extends CI_Model {
  function test_result_suggestion_create() {
  ...
  function test_result_suggestion_update() {
    $test_result_suggestion_post['test_master.test_master_id'] = $this->session->test_master_test_master_id;
  ...
  function test_result_suggestion_get_records() {
    ...
    $this->db->select('test_master.test_master_id AS test_result_suggestion_test_master_id, test_result_suggestion.suggestion_id AS test_result_suggestion_suggestion_id,
    test_result_suggestion.test_master_id AS test_result_suggestion_test_master_id, test_result_suggestion.suggestion AS test_result_suggestion_suggestion,
    test_result_suggestion.temp_suggestion_id AS test_result_suggestion_temp_suggestion_id')->from('test_result_suggestion');
