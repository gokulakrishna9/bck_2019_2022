<?php class Shift_model extends CI_Model {
  ...
  function shift_get_records() {
    ...
    $this->db->select('shift.shift_id AS shift_shift_id, shift.shift AS shift_shift,
    shift.description AS shift_description, shift.time_in AS shift_time_in,
