<?php class Staff_service_model extends CI_Model {
  ...
  function staff_service_get_records() {
    ...
    $this->db->select('staff_service.service_id AS staff_service_service_id, staff_service.date_of_joining AS staff_service_date_of_joining,
    staff_service.designation AS staff_service_designation, staff_service.institution AS staff_service_institution')->from('staff_service');
