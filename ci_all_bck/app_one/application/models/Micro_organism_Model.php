<?php class Micro_organism_model extends CI_Model {
  function micro_organism_create() {
    $micro_organism_post = [];
  ...
  function micro_organism_update() {
    $micro_organism_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $micro_organism_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function micro_organism_get_records() {
    ...
    micro_organism.micro_organism_id AS micro_organism_micro_organism_id, micro_organism.micro_organism AS micro_organism_micro_organism,
    micro_organism.micro_organism_type AS micro_organism_micro_organism_type, micro_organism.hospital_id AS micro_organism_hospital_id,
