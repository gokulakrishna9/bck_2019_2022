<?php class State_model extends CI_Model {
  ...
  function state_get_records() {
    ...
    state.state_id AS state_state_id, state.state AS state_state,
    state.latitude AS state_latitude, state.longitude AS state_longitude,
    state.country_id AS state_country_id')->from('state');
