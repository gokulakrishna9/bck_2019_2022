<?php class User_function_model extends CI_Model {
  ...
  function user_function_get_records() {
    ...
    $this->db->select('user_function.user_function_id AS user_function_user_function_id, user_function.user_function AS user_function_user_function,
    user_function.user_function_display AS user_function_user_function_display, user_function.description AS user_function_description')->from('user_function');
