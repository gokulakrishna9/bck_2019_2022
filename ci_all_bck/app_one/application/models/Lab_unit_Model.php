<?php class Lab_unit_model extends CI_Model {
  ...
  function lab_unit_get_records() {
    ...
    lab_unit.lab_unit_id AS lab_unit_lab_unit_id, lab_unit.lab_unit AS lab_unit_lab_unit,
    lab_unit.hospital_id AS lab_unit_hospital_id, lab_unit.temp_lab_unit_id AS lab_unit_temp_lab_unit_id')->from('lab_unit');
