<?php class Indent_model extends CI_Model {
  ...
  function indent_get_records() {
    ...
    indent.indent_id AS indent_indent_id, indent.hospital_id AS indent_hospital_id,
    indent.approve_date_time AS indent_approve_date_time, indent.issue_date_time AS indent_issue_date_time,
    indent.indent_date AS indent_indent_date, indent.from_id AS indent_from_id,
    indent.to_id AS indent_to_id, indent.orderby_id AS indent_orderby_id,
    indent.approver_id AS indent_approver_id, indent.issuer_id AS indent_issuer_id,
    indent.indent_status AS indent_indent_status, indent.insert_user_id AS indent_insert_user_id,
    indent.update_user_id AS indent_update_user_id, indent.insert_datetime AS indent_insert_datetime,
    indent.update_datetime AS indent_update_datetime')->from('indent');
