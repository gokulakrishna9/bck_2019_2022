<?php class Staff_applicant_qualification_master_model extends CI_Model {
  ...
  function staff_applicant_qualification_master_update() {
  ...
  function staff_applicant_qualification_master_get_records() {
    ...
    $this->db->select('staff_applicant_qualification_master.qualification_id AS staff_applicant_qualification_master_qualification_id, staff_applicant_qualification_master.qualification AS staff_applicant_qualification_master_qualification,
