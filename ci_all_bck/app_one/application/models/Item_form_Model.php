<?php class Item_form_model extends CI_Model {
  ...
  function item_form_get_records() {
    ...
    $this->db->select('item_form.item_form_id AS item_form_item_form_id, item_form.item_form AS item_form_item_form')->from('item_form');
