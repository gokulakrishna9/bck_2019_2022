<?php class Item_batch_model extends CI_Model {
  ...
  function item_batch_get_records() {
    ...
    item_batch.batch_id AS item_batch_batch_id, item_batch.item_id AS item_batch_item_id,
    item_batch.item_quantity AS item_batch_item_quantity, item_batch.batch_number AS item_batch_batch_number')->from('item_batch');
