<?php class Test_status_model extends CI_Model {
  ...
  function test_status_get_records() {
    ...
    test_status.test_status_id AS test_status_test_status_id, test_status.test_id AS test_status_test_id,
    test_status.test_status_type_id AS test_status_test_status_type_id, test_status.status_date_time AS test_status_status_date_time')->from('test_status');
