<?php class Bb_donation_model extends CI_Model {
  ...
  function bb_donation_get_records() {
    ...
    $this->db->select('blood_donor.donor_id AS bb_donation_donor_id, bb_replacement_patient.replacement_patient_id AS bb_donation_replacement_patient_id,
    bb_status.status_id AS bb_donation_status_id, blood_donation_camp.camp_id AS bb_donation_camp_id,
    blood_donation_camp_date.camp_id AS bb_donation_camp_id, hospital.hospital_id AS bb_donation_hospital_id,
    staff_previous_hospital.hospital_id AS bb_donation_hospital_id, bb_donation.donation_id AS bb_donation_donation_id,
    bb_donation.donor_id AS bb_donation_donor_id, bb_donation.replacement_patient_id AS bb_donation_replacement_patient_id,
    bb_donation.weight AS bb_donation_weight, bb_donation.pulse AS bb_donation_pulse,
    bb_donation.hb AS bb_donation_hb, bb_donation.sbp AS bb_donation_sbp,
    bb_donation.dbp AS bb_donation_dbp, bb_donation.temperature AS bb_donation_temperature,
    bb_donation.blood_unit_num AS bb_donation_blood_unit_num, bb_donation.segment_num AS bb_donation_segment_num,
    bb_donation.bag_type AS bb_donation_bag_type, bb_donation.collected_by AS bb_donation_collected_by,
    bb_donation.donation_date AS bb_donation_donation_date, bb_donation.status AS bb_donation_status,
    bb_donation.status_id AS bb_donation_status_id, bb_donation.camp_id AS bb_donation_camp_id,
    bb_donation.hospital_id AS bb_donation_hospital_id, bb_donation.screening_result AS bb_donation_screening_result,
    bb_donation.donation_time AS bb_donation_donation_time')->from('bb_donation');
