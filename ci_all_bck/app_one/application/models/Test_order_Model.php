<?php class Test_order_model extends CI_Model {
  ...
  function test_order_get_records() {
    ...
    $this->db->select('mlc.visit_id AS test_order_visit_id, patient_visit.visit_id AS test_order_visit_id,
    test_area.test_area_id AS test_order_test_area_id, hospital.hospital_id AS test_order_hospital_id,
    staff_previous_hospital.hospital_id AS test_order_hospital_id, test_order.order_id AS test_order_order_id,
    test_order.visit_id AS test_order_visit_id, test_order.doctor_id AS test_order_doctor_id,
    test_order.test_area_id AS test_order_test_area_id, test_order.order_date_time AS test_order_order_date_time,
    test_order.received_date_time AS test_order_received_date_time, test_order.order_status AS test_order_order_status,
    test_order.hospital_id AS test_order_hospital_id, test_order.temp_order_id AS test_order_temp_order_id')->from('test_order');
