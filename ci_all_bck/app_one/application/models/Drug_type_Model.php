<?php class Drug_type_model extends CI_Model {
  ...
  function drug_type_get_records() {
    ...
    $this->db->select('drug_type.drug_type_id AS drug_type_drug_type_id, drug_type.drug_type AS drug_type_drug_type,
    drug_type.description AS drug_type_description')->from('drug_type');
