<?php class Micro_organism_test_model extends CI_Model {
  function micro_organism_test_create() {
  ...
  function micro_organism_test_update() {
    $micro_organism_test_post['test.test_id'] = $this->session->test_test_id;
    $micro_organism_test_post['micro_organism.micro_organism_id'] = $this->session->micro_organism_micro_organism_id;
  ...
  function micro_organism_test_get_records() {
    ...
    $this->db->select('test.test_id AS micro_organism_test_test_id, micro_organism.micro_organism_id AS micro_organism_test_micro_organism_id,
    micro_organism_test.micro_organism_test_id AS micro_organism_test_micro_organism_test_id, micro_organism_test.test_id AS micro_organism_test_test_id,
    micro_organism_test.micro_organism_id AS micro_organism_test_micro_organism_id, micro_organism_test.temp_micro_organism_test_id AS micro_organism_test_temp_micro_organism_test_id')->from('micro_organism_test');
