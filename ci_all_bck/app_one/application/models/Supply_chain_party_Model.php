<?php class Supply_chain_party_model extends CI_Model {
  function supply_chain_party_create() {
  ...
  function supply_chain_party_update() {
    $supply_chain_party_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $supply_chain_party_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
    $supply_chain_party_post['department.department_id'] = $this->session->department_department_id;
    $supply_chain_party_post['area.area_id'] = $this->session->area_area_id;
  ...
  function supply_chain_party_get_records() {
    ...
    $this->db->select('hospital.hospital_id AS supply_chain_party_hospital_id, staff_previous_hospital.hospital_id AS supply_chain_party_hospital_id,
    department.department_id AS supply_chain_party_department_id, area.area_id AS supply_chain_party_area_id,
    vendor.vendor_id AS supply_chain_party_vendor_id, supply_chain_party.supply_chain_party_id AS supply_chain_party_supply_chain_party_id,
    supply_chain_party.supply_chain_party_name AS supply_chain_party_supply_chain_party_name, supply_chain_party.hospital_id AS supply_chain_party_hospital_id,
    supply_chain_party.department_id AS supply_chain_party_department_id, supply_chain_party.area_id AS supply_chain_party_area_id,
