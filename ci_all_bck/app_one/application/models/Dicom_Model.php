<?php class Dicom_model extends CI_Model {
  ...
  function dicom_get_records() {
    ...
    $this->db->select('mlc.visit_id AS dicom_visit_id, patient_visit.visit_id AS dicom_visit_id,
    test.test_id AS dicom_test_id, dicom.dicom_id AS dicom_dicom_id,
    dicom.visit_id AS dicom_visit_id, dicom.test_id AS dicom_test_id,
    dicom.study_datetime AS dicom_study_datetime, dicom.modality AS dicom_modality,
    dicom.study_id AS dicom_study_id, dicom.filepath AS dicom_filepath')->from('dicom');
