<?php class Occupation_model extends CI_Model {
  ...
  function occupation_get_records() {
    ...
    $this->db->select('occupation.occupation_id AS occupation_occupation_id, occupation.occupation AS occupation_occupation')->from('occupation');
