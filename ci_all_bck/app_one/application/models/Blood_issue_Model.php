<?php class Blood_issue_model extends CI_Model {
  ...
  function blood_issue_get_records() {
    ...
    $this->db->select('blood_request.request_id AS blood_issue_request_id, service_record.request_id AS blood_issue_request_id,
    hospital.hospital_id AS blood_issue_hospital_id, staff_previous_hospital.hospital_id AS blood_issue_hospital_id,
    blood_issue.issue_id AS blood_issue_issue_id, blood_issue.issue_date AS blood_issue_issue_date,
    blood_issue.issue_time AS blood_issue_issue_time, blood_issue.request_id AS blood_issue_request_id,
    blood_issue.issued_by AS blood_issue_issued_by, blood_issue.cross_matched_by AS blood_issue_cross_matched_by,
    blood_issue.hospital_id AS blood_issue_hospital_id')->from('blood_issue');
