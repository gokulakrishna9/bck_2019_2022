<?php class Helpline_resolution_status_model extends CI_Model {
  ...
  function helpline_resolution_status_update() {
  ...
  function helpline_resolution_status_get_records() {
    ...
    $this->db->select('helpline_resolution_status.resolution_status_id AS helpline_resolution_status_resolution_status_id, helpline_resolution_status.resolution_status AS helpline_resolution_status_resolution_status,
    helpline_resolution_status.note AS helpline_resolution_status_note')->from('helpline_resolution_status');
