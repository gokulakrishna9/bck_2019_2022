<?php class Item_type_model extends CI_Model {
  ...
  function item_type_get_records() {
    ...
    $this->db->select('item_type.item_type_id AS item_type_item_type_id, item_type.item_type AS item_type_item_type')->from('item_type');
