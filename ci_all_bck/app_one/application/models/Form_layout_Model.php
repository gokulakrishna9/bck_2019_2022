<?php class Form_layout_model extends CI_Model {
  ...
  function form_layout_get_records() {
    ...
    $this->db->select('form.form_id AS form_layout_form_id, form_layout.id AS form_layout_id,
    form_layout.field_name AS form_layout_field_name, form_layout.default_value AS form_layout_default_value,
    form_layout.mandatory AS form_layout_mandatory, form_layout.form_id AS form_layout_form_id')->from('form_layout');
