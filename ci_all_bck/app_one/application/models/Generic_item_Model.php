<?php class Generic_item_model extends CI_Model {
  ...
  function generic_item_get_records() {
    ...
    generic_item.generic_item_id AS generic_item_generic_item_id, generic_item.generic_name AS generic_item_generic_name,
    generic_item.drug_type_id AS generic_item_drug_type_id, generic_item.item_type_id AS generic_item_item_type_id')->from('generic_item');
