<?php class User_department_link_model extends CI_Model {
  function user_department_link_create() {
  ...
  function user_department_link_update() {
    $user_department_link_post['bb_user.user_id'] = $this->session->bb_user_user_id;
    $user_department_link_post['user.user_id'] = $this->session->user_user_id;
    $user_department_link_post['department.department_id'] = $this->session->department_department_id;
  ...
  function user_department_link_get_records() {
    ...
    $this->db->select('bb_user.user_id AS user_department_link_user_id, user.user_id AS user_department_link_user_id,
    department.department_id AS user_department_link_department_id, user_department_link.link_id AS user_department_link_link_id,
    user_department_link.user_id AS user_department_link_user_id, user_department_link.department_id AS user_department_link_department_id')->from('user_department_link');
