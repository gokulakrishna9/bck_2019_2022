<?php class List_department_model extends CI_Model {
  ...
  function list_department_update() {
  ...
  function list_department_get_records() {
    ...
    $this->db->select('list_department.list_department_id AS list_department_list_department_id, list_department.department AS list_department_department')->from('list_department');
