<?php class User_model extends CI_Model {
  ...
  function user_get_records() {
    ...
    $this->db->select('staff.staff_id AS user_staff_id, user.user_id AS user_user_id,
    user.username AS user_username, user.password AS user_password,
    user.staff_id AS user_staff_id, user.present_login_time AS user_present_login_time,
    user.present_login_date AS user_present_login_date, user.past_login_time AS user_past_login_time,
    user.past_login_date AS user_past_login_date, user.temp_user_id AS user_temp_user_id')->from('user');
