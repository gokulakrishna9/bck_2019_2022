<?php class Patient_obstetric_history_model extends CI_Model {
  function patient_obstetric_history_create() {
  ...
  function patient_obstetric_history_update() {
    $patient_obstetric_history_post['bb_external_patient.patient_id'] = $this->session->bb_external_patient_patient_id;
    $patient_obstetric_history_post['patient.patient_id'] = $this->session->patient_patient_id;
  ...
  function patient_obstetric_history_get_records() {
    ...
    patient_obstetric_history.obstetric_history_id AS patient_obstetric_history_obstetric_history_id, patient_obstetric_history.patient_id AS patient_obstetric_history_patient_id,
    patient_obstetric_history.conception_type AS patient_obstetric_history_conception_type, patient_obstetric_history.pregnancy_number AS patient_obstetric_history_pregnancy_number,
    patient_obstetric_history.delivered AS patient_obstetric_history_delivered, patient_obstetric_history.imp_date AS patient_obstetric_history_imp_date,
    patient_obstetric_history.edd_date AS patient_obstetric_history_edd_date, patient_obstetric_history.delivery_outcome AS patient_obstetric_history_delivery_outcome,
    patient_obstetric_history.booked AS patient_obstetric_history_booked, patient_obstetric_history.delivery_mode_id AS patient_obstetric_history_delivery_mode_id,
    patient_obstetric_history.date_of_birth AS patient_obstetric_history_date_of_birth, patient_obstetric_history.gender AS patient_obstetric_history_gender,
    patient_obstetric_history.weight_at_birth AS patient_obstetric_history_weight_at_birth, patient_obstetric_history.apgar AS patient_obstetric_history_apgar,
    patient_obstetric_history.nicu_admission AS patient_obstetric_history_nicu_admission, patient_obstetric_history.nicu_admission_reason AS patient_obstetric_history_nicu_admission_reason,
    patient_obstetric_history.alive AS patient_obstetric_history_alive, patient_obstetric_history.date_of_death AS patient_obstetric_history_date_of_death,
    patient_obstetric_history.cause_of_death AS patient_obstetric_history_cause_of_death')->from('patient_obstetric_history');
