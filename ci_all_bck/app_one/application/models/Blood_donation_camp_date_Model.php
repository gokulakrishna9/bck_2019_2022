<?php class Blood_donation_camp_date_model extends CI_Model {
  ...
  function blood_donation_camp_date_update() {
  ...
  function blood_donation_camp_date_get_records() {
    ...
    $this->db->select('blood_donation_camp_date.camp_id AS blood_donation_camp_date_camp_id, blood_donation_camp_date.camp_date AS blood_donation_camp_date_camp_date')->from('blood_donation_camp_date');
