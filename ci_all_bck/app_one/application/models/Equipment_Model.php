<?php class Equipment_model extends CI_Model {
  ...
  function equipment_get_records() {
    ...
    $this->db->select('equipment_type.equipment_type_id AS equipment_equipment_type_id, vendor.vendor_id AS equipment_vendor_id,
    hospital.hospital_id AS equipment_hospital_id, staff_previous_hospital.hospital_id AS equipment_hospital_id,
    department.department_id AS equipment_department_id, area.area_id AS equipment_area_id,
    unit.unit_id AS equipment_unit_id, staff.staff_id AS equipment_staff_id,
    equipment.equipment_id AS equipment_equipment_id, equipment.equipment_type_id AS equipment_equipment_type_id,
    equipment.make AS equipment_make, equipment.model AS equipment_model,
    equipment.serial_number AS equipment_serial_number, equipment.asset_number AS equipment_asset_number,
    equipment.procured_by AS equipment_procured_by, equipment.cost AS equipment_cost,
    equipment.supplier AS equipment_supplier, equipment.vendor_id AS equipment_vendor_id,
    equipment.supply_date AS equipment_supply_date, equipment.warranty_start_date AS equipment_warranty_start_date,
    equipment.warranty_end_date AS equipment_warranty_end_date, equipment.service_engineer AS equipment_service_engineer,
    equipment.service_engineer_contact AS equipment_service_engineer_contact, equipment.service_person_id AS equipment_service_person_id,
    equipment.hospital_id AS equipment_hospital_id, equipment.department_id AS equipment_department_id,
    equipment.area_id AS equipment_area_id, equipment.unit_id AS equipment_unit_id,
    equipment.staff_id AS equipment_staff_id, equipment.equipment_status AS equipment_equipment_status')->from('equipment');
