<?php class Department_model extends CI_Model {
  ...
  function department_get_records() {
    ...
    department.department_id AS department_department_id, department.hospital_id AS department_hospital_id,
    department.department AS department_department, department.description AS department_description,
    department.lab_report_staff_id AS department_lab_report_staff_id, department.department_email AS department_department_email,
    department.number_of_units AS department_number_of_units, department.op_room_no AS department_op_room_no,
    department.clinical AS department_clinical, department.floor AS department_floor,
    department.mon AS department_mon, department.tue AS department_tue,
    department.wed AS department_wed, department.thr AS department_thr,
    department.fri AS department_fri, department.sat AS department_sat,
    department.temp_department_id AS department_temp_department_id')->from('department');
