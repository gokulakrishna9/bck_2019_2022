<?php class Affiliation_model extends CI_Model {
  ...
  function affiliation_get_records() {
    ...
    $this->db->select('staff.staff_id AS affiliation_staff_id, affiliation.affiliation_id AS affiliation_affiliation_id,
    affiliation.staff_id AS affiliation_staff_id, affiliation.affiliated_institution AS affiliation_affiliated_institution')->from('affiliation');
