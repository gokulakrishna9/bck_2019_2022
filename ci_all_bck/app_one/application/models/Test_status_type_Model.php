<?php class Test_status_type_model extends CI_Model {
  ...
  function test_status_type_update() {
  ...
  function test_status_type_get_records() {
    ...
    $this->db->select('test_status_type.test_status_type_id AS test_status_type_test_status_type_id, test_status_type.test_status AS test_status_type_test_status')->from('test_status_type');
