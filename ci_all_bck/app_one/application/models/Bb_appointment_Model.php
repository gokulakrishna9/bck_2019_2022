<?php class Bb_appointment_model extends CI_Model {
  function bb_appointment_create() {
    $bb_appointment_post = [];
  ...
  function bb_appointment_update() {
    $bb_appointment_post['blood_donor.donor_id'] = $this->session->blood_donor_donor_id;
    $bb_appointment_post['bb_slot.slot_id'] = $this->session->bb_slot_slot_id;
    $bb_appointment_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $bb_appointment_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function bb_appointment_get_records() {
    ...
    $this->db->select('blood_donor.donor_id AS bb_appointment_donor_id, bb_slot.slot_id AS bb_appointment_slot_id,
    hospital.hospital_id AS bb_appointment_hospital_id, staff_previous_hospital.hospital_id AS bb_appointment_hospital_id,
    bb_appointment.appointment_id AS bb_appointment_appointment_id, bb_appointment.donor_id AS bb_appointment_donor_id,
    bb_appointment.slot_id AS bb_appointment_slot_id, bb_appointment.datetime AS bb_appointment_datetime,
    bb_appointment.status AS bb_appointment_status, bb_appointment.hospital_id AS bb_appointment_hospital_id')->from('bb_appointment');
