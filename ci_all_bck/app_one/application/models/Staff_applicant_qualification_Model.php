<?php class Staff_applicant_qualification_model extends CI_Model {
  function staff_applicant_qualification_create() {
  ...
  function staff_applicant_qualification_update() {
    $staff_applicant_qualification_post['staff_applicant.applicant_id'] = $this->session->staff_applicant_applicant_id;
    $staff_applicant_qualification_post['qualification.qualification_id'] = $this->session->qualification_qualification_id;
    $staff_applicant_qualification_post['staff_applicant_qualification_master.qualification_id'] = $this->session->staff_applicant_qualification_master_qualification_id;
    $staff_applicant_qualification_post['staff_applicant_college.college_id'] = $this->session->staff_applicant_college_college_id;
  ...
  function staff_applicant_qualification_get_records() {
    ...
    $this->db->select('staff_applicant.applicant_id AS staff_applicant_qualification_applicant_id, qualification.qualification_id AS staff_applicant_qualification_qualification_id,
    staff_applicant_qualification_master.qualification_id AS staff_applicant_qualification_qualification_id, staff_applicant_college.college_id AS staff_applicant_qualification_college_id,
    staff.staff_id AS staff_applicant_qualification_staff_id, staff_applicant_qualification.id AS staff_applicant_qualification_id,
    staff_applicant_qualification.applicant_id AS staff_applicant_qualification_applicant_id, staff_applicant_qualification.qualification_id AS staff_applicant_qualification_qualification_id,
    staff_applicant_qualification.college_id AS staff_applicant_qualification_college_id, staff_applicant_qualification.registration_number AS staff_applicant_qualification_registration_number,
    staff_applicant_qualification.from_date AS staff_applicant_qualification_from_date, staff_applicant_qualification.to_date AS staff_applicant_qualification_to_date,
    staff_applicant_qualification.staff_id AS staff_applicant_qualification_staff_id')->from('staff_applicant_qualification');
