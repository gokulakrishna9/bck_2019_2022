<?php class Test_method_model extends CI_Model {
  ...
  function test_method_get_records() {
    ...
    test_method.test_method_id AS test_method_test_method_id, test_method.test_method AS test_method_test_method,
    test_method.accredition_logo AS test_method_accredition_logo, test_method.hospital_id AS test_method_hospital_id,
    test_method.temp_test_method_id AS test_method_temp_test_method_id')->from('test_method');
