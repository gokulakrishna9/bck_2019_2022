<?php class User_activity_model extends CI_Model {
  ...
  function user_activity_get_records() {
    ...
    $this->db->select('mlc.visit_id AS user_activity_visit_id, patient_visit.visit_id AS user_activity_visit_id,
    bb_user.user_id AS user_activity_user_id, user.user_id AS user_activity_user_id,
    user_activity.update_id AS user_activity_update_id, user_activity.visit_id AS user_activity_visit_id,
    user_activity.user_id AS user_activity_user_id, user_activity.register AS user_activity_register,
    user_activity.event_date AS user_activity_event_date')->from('user_activity');
