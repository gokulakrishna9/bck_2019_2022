<?php class Dashboards_model extends CI_Model {
  ...
  function dashboards_get_records() {
    ...
    $this->db->select('dashboards.dashboard_id AS dashboards_dashboard_id, dashboards.organization AS dashboards_organization,
    dashboards.short_name AS dashboards_short_name, dashboards.type6 AS dashboards_type6,
    dashboards.state AS dashboards_state, dashboards.logo AS dashboards_logo,
    dashboards.state_alias AS dashboards_state_alias, dashboards.org_label AS dashboards_org_label')->from('dashboards');
