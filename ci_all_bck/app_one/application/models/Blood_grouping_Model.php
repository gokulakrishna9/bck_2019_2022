<?php class Blood_grouping_model extends CI_Model {
  function blood_grouping_create() {
    $blood_grouping_post = [];
  ...
  function blood_grouping_update() {
    $blood_grouping_post['bb_donation.donation_id'] = $this->session->bb_donation_donation_id;
    $blood_grouping_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $blood_grouping_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function blood_grouping_get_records() {
    ...
    staff_previous_hospital.hospital_id AS blood_grouping_hospital_id, blood_grouping.grouping_id AS blood_grouping_grouping_id,
    blood_grouping.donation_id AS blood_grouping_donation_id, blood_grouping.blood_group AS blood_grouping_blood_group,
    blood_grouping.sub_group AS blood_grouping_sub_group, blood_grouping.anti_a AS blood_grouping_anti_a,
    blood_grouping.anti_b AS blood_grouping_anti_b, blood_grouping.anti_ab AS blood_grouping_anti_ab,
    blood_grouping.anti_d AS blood_grouping_anti_d, blood_grouping.a_cells AS blood_grouping_a_cells,
    blood_grouping.b_cells AS blood_grouping_b_cells, blood_grouping.o_cells AS blood_grouping_o_cells,
    blood_grouping.du AS blood_grouping_du, blood_grouping.forward_done_by AS blood_grouping_forward_done_by,
    blood_grouping.reverse_done_by AS blood_grouping_reverse_done_by, blood_grouping.grouping_date AS blood_grouping_grouping_date,
    blood_grouping.hospital_id AS blood_grouping_hospital_id')->from('blood_grouping');
