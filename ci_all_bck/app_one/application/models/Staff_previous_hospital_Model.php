<?php class Staff_previous_hospital_model extends CI_Model {
  function staff_previous_hospital_create() {
  ...
  function staff_previous_hospital_update() {
    $staff_previous_hospital_post['district.district_id'] = $this->session->district_district_id;
  ...
  function staff_previous_hospital_get_records() {
    ...
    $this->db->select('district.district_id AS staff_previous_hospital_district_id, staff_previous_hospital.hospital_id AS staff_previous_hospital_hospital_id,
    staff_previous_hospital.hospital_name AS staff_previous_hospital_hospital_name, staff_previous_hospital.address AS staff_previous_hospital_address,
    staff_previous_hospital.district_id AS staff_previous_hospital_district_id, staff_previous_hospital.public_institution_flag AS staff_previous_hospital_public_institution_flag')->from('staff_previous_hospital');
