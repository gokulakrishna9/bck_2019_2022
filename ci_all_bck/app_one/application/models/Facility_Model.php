<?php class Facility_model extends CI_Model {
  ...
  function facility_get_records() {
    ...
    facility.facility_id AS facility_facility_id, facility.facility_name AS facility_facility_name,
    facility.facility_type_id AS facility_facility_type_id, facility.address AS facility_address,
    facility.village_town_id AS facility_village_town_id, facility.latitude AS facility_latitude,
    facility.longitude AS facility_longitude')->from('facility');
