<?php class Default_setting_model extends CI_Model {
  ...
  function default_setting_update() {
  ...
  function default_setting_get_records() {
    ...
    $this->db->select('default_setting.setting_id AS default_setting_setting_id, default_setting.table AS default_setting_table,
    default_setting.primary_key AS default_setting_primary_key, default_setting.default_value AS default_setting_default_value,
    default_setting.default_value_text AS default_setting_default_value_text')->from('default_setting');
