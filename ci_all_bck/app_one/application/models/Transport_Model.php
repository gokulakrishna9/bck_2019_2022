<?php class Transport_model extends CI_Model {
  ...
  function transport_get_records() {
    ...
    $this->db->select('mlc.visit_id AS transport_visit_id, patient_visit.visit_id AS transport_visit_id,
    staff.staff_id AS transport_staff_id, transport.transport_id AS transport_transport_id,
    transport.visit_id AS transport_visit_id, transport.from_area_id AS transport_from_area_id,
    transport.to_area_id AS transport_to_area_id, transport.staff_id AS transport_staff_id,
    transport.start_date_time AS transport_start_date_time, transport.end_date_time AS transport_end_date_time,
    transport.entry_date_time AS transport_entry_date_time, transport.transport_type AS transport_transport_type,
    transport.note AS transport_note')->from('transport');
