<?php class Service_record_model extends CI_Model {
  function service_record_create() {
    $service_record_post = [];
  ...
  function service_record_update() {
    $service_record_post['equipment.equipment_id'] = $this->session->equipment_equipment_id;
    $service_record_post['bb_user.user_id'] = $this->session->bb_user_user_id;
    $service_record_post['user.user_id'] = $this->session->user_user_id;
    $service_record_post['vendor.vendor_id'] = $this->session->vendor_vendor_id;
  ...
  function service_record_get_records() {
    ...
    service_record.request_id AS service_record_request_id, service_record.equipment_id AS service_record_equipment_id,
    service_record.user_id AS service_record_user_id, service_record.call_date AS service_record_call_date,
    service_record.call_time AS service_record_call_time, service_record.call_information_type AS service_record_call_information_type,
    service_record.call_information AS service_record_call_information, service_record.vendor_id AS service_record_vendor_id,
    service_record.contact_person_id AS service_record_contact_person_id, service_record.service_provider AS service_record_service_provider,
    service_record.service_person AS service_record_service_person, service_record.service_person_remarks AS service_record_service_person_remarks,
    service_record.service_date AS service_record_service_date, service_record.service_time AS service_record_service_time,
    service_record.problem_status AS service_record_problem_status, service_record.working_status AS service_record_working_status')->from('service_record');
