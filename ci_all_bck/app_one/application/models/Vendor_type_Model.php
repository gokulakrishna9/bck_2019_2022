<?php class Vendor_type_model extends CI_Model {
  ...
  function vendor_type_get_records() {
    ...
    $this->db->select('vendor_type.vendor_type_id AS vendor_type_vendor_type_id, vendor_type.vendor_type AS vendor_type_vendor_type')->from('vendor_type');
