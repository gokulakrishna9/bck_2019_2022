<?php class Bb_user_model extends CI_Model {
  ...
  function bb_user_get_records() {
    ...
    bb_user.user_id AS bb_user_user_id, bb_user.username AS bb_user_username,
    bb_user.password AS bb_user_password, bb_user.registration_date AS bb_user_registration_date,
    bb_user.registrar AS bb_user_registrar, bb_user.examiner AS bb_user_examiner,
    bb_user.technician AS bb_user_technician, bb_user.screener AS bb_user_screener,
    bb_user.issuer AS bb_user_issuer, bb_user.requester AS bb_user_requester,
    bb_user.admin AS bb_user_admin, bb_user.displayname AS bb_user_displayname,
    bb_user.hospital_id AS bb_user_hospital_id')->from('bb_user');
