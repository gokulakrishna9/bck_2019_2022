<?php class Bb_status_model extends CI_Model {
  ...
  function bb_status_get_records() {
    ...
    $this->db->select('bb_status.status_id AS bb_status_status_id, bb_status.status AS bb_status_status')->from('bb_status');
