<?php class Item_model extends CI_Model {
  ...
  function item_get_records() {
    ...
    $this->db->select('generic_item.generic_item_id AS item_generic_item_id, dosage.dosage_id AS item_dosage_id,
    item_form.item_form_id AS item_item_form_id, item.item_id AS item_item_id,
    item.item_name AS item_item_name, item.generic_item_id AS item_generic_item_id,
    item.dosage_id AS item_dosage_id, item.item_form_id AS item_item_form_id,
    item.quantity AS item_quantity, item.manufacturer_vendor_id AS item_manufacturer_vendor_id,
    item.description AS item_description, item.model AS item_model,
    item.lot_batch_id AS item_lot_batch_id, item.supplier_vendor_id AS item_supplier_vendor_id,
    item.supply_date AS item_supply_date, item.cost AS item_cost,
    item.warranty_period AS item_warranty_period, item.manufacturing_date AS item_manufacturing_date,
    item.expire_date AS item_expire_date, item.item_status AS item_item_status')->from('item');
