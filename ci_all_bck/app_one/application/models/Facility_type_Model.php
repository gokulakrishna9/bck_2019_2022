<?php class Facility_type_model extends CI_Model {
  ...
  function facility_type_get_records() {
    ...
    $this->db->select('facility_type.facility_type_id AS facility_type_facility_type_id, facility_type.facility_type AS facility_type_facility_type')->from('facility_type');
