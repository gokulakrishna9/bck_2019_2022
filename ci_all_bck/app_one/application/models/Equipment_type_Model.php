<?php class Equipment_type_model extends CI_Model {
  ...
  function equipment_type_get_records() {
    ...
    $this->db->select('equipment_type.equipment_type_id AS equipment_type_equipment_type_id, equipment_type.equipment_type AS equipment_type_equipment_type')->from('equipment_type');
