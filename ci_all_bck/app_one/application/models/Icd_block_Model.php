<?php class Icd_block_model extends CI_Model {
  ...
  function icd_block_get_records() {
    ...
    icd_block.chapter_id AS icd_block_chapter_id, icd_block.block_title AS icd_block_block_title')->from('icd_block');
