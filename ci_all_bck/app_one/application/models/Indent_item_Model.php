<?php class Indent_item_model extends CI_Model {
  ...
  function indent_item_get_records() {
    ...
    item_master.item_id AS indent_item_item_id, indent_item.indent_item_id AS indent_item_indent_item_id,
    indent_item.hospital_id AS indent_item_hospital_id, indent_item.indent_id AS indent_item_indent_id,
    indent_item.item_id AS indent_item_item_id, indent_item.quantity_indented AS indent_item_quantity_indented,
    indent_item.quantity_approved AS indent_item_quantity_approved, indent_item.quantity_issued AS indent_item_quantity_issued,
    indent_item.indent_status AS indent_item_indent_status, indent_item.issue_date AS indent_item_issue_date,
    indent_item.consumption_status AS indent_item_consumption_status')->from('indent_item');
