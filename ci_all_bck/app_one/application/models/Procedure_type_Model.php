<?php class Procedure_type_model extends CI_Model {
  ...
  function procedure_type_update() {
  ...
  function procedure_type_get_records() {
    ...
    $this->db->select('procedure_type.procedure_type_id AS procedure_type_procedure_type_id, procedure_type.procedure_type AS procedure_type_procedure_type')->from('procedure_type');
