<?php class Blood_donor_model extends CI_Model {
  ...
  function blood_donor_get_records() {
    ...
    blood_donor.donor_id AS blood_donor_donor_id, blood_donor.name AS blood_donor_name,
    blood_donor.parent_spouse AS blood_donor_parent_spouse, blood_donor.maritial_status AS blood_donor_maritial_status,
    blood_donor.occupation AS blood_donor_occupation, blood_donor.dob AS blood_donor_dob,
    blood_donor.age AS blood_donor_age, blood_donor.sex AS blood_donor_sex,
    blood_donor.blood_group AS blood_donor_blood_group, blood_donor.sub_group AS blood_donor_sub_group,
    blood_donor.phone AS blood_donor_phone, blood_donor.email AS blood_donor_email,
    blood_donor.address AS blood_donor_address, blood_donor.alerts AS blood_donor_alerts,
    blood_donor.hospital_id AS blood_donor_hospital_id')->from('blood_donor');
