<?php class Bb_external_patient_model extends CI_Model {
  function bb_external_patient_create() {
  ...
  function bb_external_patient_update() {
    $bb_external_patient_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $bb_external_patient_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
  ...
  function bb_external_patient_get_records() {
    ...
    bb_external_patient.patient_id AS bb_external_patient_patient_id, bb_external_patient.first_name AS bb_external_patient_first_name,
    bb_external_patient.last_name AS bb_external_patient_last_name, bb_external_patient.age AS bb_external_patient_age,
    bb_external_patient.diagnosis AS bb_external_patient_diagnosis, bb_external_patient.ward_unit AS bb_external_patient_ward_unit,
    bb_external_patient.doctor AS bb_external_patient_doctor, bb_external_patient.hospital_id AS bb_external_patient_hospital_id')->from('bb_external_patient');
