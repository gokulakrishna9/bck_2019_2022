<?php class Hr_transaction_type_model extends CI_Model {
  ...
  function hr_transaction_type_update() {
  ...
  function hr_transaction_type_get_records() {
    ...
    $this->db->select('hr_transaction_type.hr_transaction_type_id AS hr_transaction_type_hr_transaction_type_id, hr_transaction_type.hr_transaction_type AS hr_transaction_type_hr_transaction_type,
    hr_transaction_type.display_flag AS hr_transaction_type_display_flag')->from('hr_transaction_type');
