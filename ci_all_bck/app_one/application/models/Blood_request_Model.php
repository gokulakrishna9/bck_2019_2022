<?php class Blood_request_model extends CI_Model {
  ...
  function blood_request_get_records() {
    ...
    $this->db->select('staff.staff_id AS blood_request_staff_id, bb_external_patient.patient_id AS blood_request_patient_id,
    patient.patient_id AS blood_request_patient_id, mlc.visit_id AS blood_request_visit_id,
    patient_visit.visit_id AS blood_request_visit_id, hospital.hospital_id AS blood_request_hospital_id,
    staff_previous_hospital.hospital_id AS blood_request_hospital_id, blood_request.request_id AS blood_request_request_id,
    blood_request.bloodbank_id AS blood_request_bloodbank_id, blood_request.request_type AS blood_request_request_type,
    blood_request.staff_id AS blood_request_staff_id, blood_request.patient_name AS blood_request_patient_name,
    blood_request.patient_age AS blood_request_patient_age, blood_request.patient_gender AS blood_request_patient_gender,
    blood_request.patient_id AS blood_request_patient_id, blood_request.request_hospital_id AS blood_request_request_hospital_id,
    blood_request.ward_unit AS blood_request_ward_unit, blood_request.referred_by_doctor AS blood_request_referred_by_doctor,
    blood_request.department AS blood_request_department, blood_request.blood_group AS blood_request_blood_group,
    blood_request.diagnosis AS blood_request_diagnosis, blood_request.blood_transfusion_required AS blood_request_blood_transfusion_required,
    blood_request.whole_blood_units AS blood_request_whole_blood_units, blood_request.packed_cell_units AS blood_request_packed_cell_units,
    blood_request.fp_units AS blood_request_fp_units, blood_request.ffp_units AS blood_request_ffp_units,
    blood_request.prp_units AS blood_request_prp_units, blood_request.platelet_concentrate_units AS blood_request_platelet_concentrate_units,
    blood_request.cryoprecipitate_units AS blood_request_cryoprecipitate_units, blood_request.request_date AS blood_request_request_date,
    blood_request.request_status AS blood_request_request_status, blood_request.rdp_units AS blood_request_rdp_units,
    blood_request.visit_id AS blood_request_visit_id, blood_request.patient_type AS blood_request_patient_type,
    blood_request.hospital_id AS blood_request_hospital_id')->from('blood_request');
