<?php class Roaster_model extends CI_Model {
  ...
  function roaster_get_records() {
    ...
    $this->db->select('staff.staff_id AS roaster_staff_id, shift.shift_id AS roaster_shift_id,
    roaster.roaster_id AS roaster_roaster_id, roaster.staff_id AS roaster_staff_id,
    roaster.date AS roaster_date, roaster.shift_id AS roaster_shift_id,
    roaster.swap_status AS roaster_swap_status, roaster.original_shift_id AS roaster_original_shift_id')->from('roaster');
