<?php class Hr_transaction_model extends CI_Model {
  function hr_transaction_create() {
    $hr_transaction_post = [];
  ...
  function hr_transaction_update() {
    $hr_transaction_post['staff.staff_id'] = $this->session->staff_staff_id;
    $hr_transaction_post['hr_transaction_type.hr_transaction_type_id'] = $this->session->hr_transaction_type_hr_transaction_type_id;
  ...
  function hr_transaction_get_records() {
    ...
    $this->db->select('staff.staff_id AS hr_transaction_staff_id, hr_transaction_type.hr_transaction_type_id AS hr_transaction_hr_transaction_type_id,
    hr_transaction.staff_id AS hr_transaction_staff_id, hr_transaction.hr_transaction_id AS hr_transaction_hr_transaction_id,
    hr_transaction.hr_transaction_type_id AS hr_transaction_hr_transaction_type_id, hr_transaction.hr_transaction_date AS hr_transaction_hr_transaction_date')->from('hr_transaction');
