<?php class Staff_applicant_work_expriance_model extends CI_Model {
  function staff_applicant_work_expriance_create() {
  ...
  function staff_applicant_work_expriance_update() {
    $staff_applicant_work_expriance_post['staff_applicant.applicant_id'] = $this->session->staff_applicant_applicant_id;
    $staff_applicant_work_expriance_post['hospital.hospital_id'] = $this->session->hospital_hospital_id;
    $staff_applicant_work_expriance_post['staff_previous_hospital.hospital_id'] = $this->session->staff_previous_hospital_hospital_id;
    $staff_applicant_work_expriance_post['staff.staff_id'] = $this->session->staff_staff_id;
  ...
  function staff_applicant_work_expriance_get_records() {
    ...
    staff_applicant_work_expriance.experiance_id AS staff_applicant_work_expriance_experiance_id, staff_applicant_work_expriance.applicant_id AS staff_applicant_work_expriance_applicant_id,
    ...
    staff_applicant_work_expriance.to_date AS staff_applicant_work_expriance_to_date, staff_applicant_work_expriance.staff_id AS staff_applicant_work_expriance_staff_id')->from('staff_applicant_work_expriance');
