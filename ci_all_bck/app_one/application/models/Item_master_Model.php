<?php class Item_master_model extends CI_Model {
  ...
  function item_master_get_records() {
    ...
    item_master.description AS item_master_description, item_master.model AS item_master_model,
    item_master.serial_number AS item_master_serial_number, item_master.asset_number AS item_master_asset_number')->from('item_master');
