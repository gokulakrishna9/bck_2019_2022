<?php class Staff_selection_parameter_model extends CI_Model {
  function staff_selection_parameter_create() {
  ...
  function staff_selection_parameter_update() {
    $staff_selection_parameter_post['staff_recruitment_drive.drive_id'] = $this->session->staff_recruitment_drive_drive_id;
  ...
  function staff_selection_parameter_get_records() {
    ...
    $this->db->select('staff_recruitment_drive.drive_id AS staff_selection_parameter_drive_id, staff_selection_parameter.parameter_id AS staff_selection_parameter_parameter_id,
    staff_selection_parameter.drive_id AS staff_selection_parameter_drive_id, staff_selection_parameter.parameter_label AS staff_selection_parameter_parameter_label,
